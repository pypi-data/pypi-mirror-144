...
def test_01_init_client(facts_client_credentials):
    cls.facts_client=AIGovFactsClient(api_key=facts_client_credentials["apikey"],experiment_name=facts_client_credentials[
                    "exp_name"],enable_autolog=False,external_model=True)
    

def test_02_get_facts_manual_scikit(caplog):
    caplog.set_level(logging.INFO)
    MulticlassIrisManual(cls.facts_client)
