...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/)
...
class OpsWorksCMClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#exceptions)
        """
    async def associate_node(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#associate_node)
        """
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#can_paginate)
        """
    async def create_backup(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#create_backup)
        """
    async def create_server(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#create_server)
        """
    async def delete_backup(self, *, BackupId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#delete_backup)
        """
    async def delete_server(self, *, ServerName: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#delete_server)
        """
    async def describe_account_attributes(self) -> DescribeAccountAttributesResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#describe_account_attributes)
        """
    async def describe_backups(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#describe_backups)
        """
    async def describe_events(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#describe_events)
        """
    async def describe_node_association_status(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#describe_node_association_status)
        """
    async def describe_servers(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#describe_servers)
        """
    async def disassociate_node(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#disassociate_node)
        """
    async def export_server_engine_attribute(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#export_server_engine_attribute)
        """
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#generate_presigned_url)
        """
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#list_tags_for_resource)
        """
    async def restore_server(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#restore_server)
        """
    async def start_maintenance(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#start_maintenance)
        """
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#tag_resource)
        """
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#untag_resource)
        """
    async def update_server(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#update_server)
        """
    async def update_server_engine_attributes(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#update_server_engine_attributes)
        """
    @overload
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#get_paginator)
        """
    @overload
    ...
    def get_waiter(self, waiter_name: Literal["node_associated"]) -> NodeAssociatedWaiter:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opsworkscm/client/#get_waiter)
        """
