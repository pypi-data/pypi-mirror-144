...
class BalanceSheetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.balance_sheets_list = _Endpoint(
            settings={
                'response_type': (PaginatedBalanceSheetList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/balance-sheets',
            ...
            callable=__balance_sheets_list
        )

        def __balance_sheets_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.balance_sheets_retrieve = _Endpoint(
            settings={
                'response_type': (BalanceSheet,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/balance-sheets/{id}',
            ...
            api_client=api_client,
            callable=__balance_sheets_retrieve
        )
