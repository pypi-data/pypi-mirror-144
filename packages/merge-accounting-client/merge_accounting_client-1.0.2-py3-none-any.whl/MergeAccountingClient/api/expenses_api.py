...
class ExpensesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.expenses_list = _Endpoint(
            settings={
                'response_type': (PaginatedExpenseList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/expenses',
            ...
            callable=__expenses_list
        )

        def __expenses_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.expenses_retrieve = _Endpoint(
            settings={
                'response_type': (Expense,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/expenses/{id}',
