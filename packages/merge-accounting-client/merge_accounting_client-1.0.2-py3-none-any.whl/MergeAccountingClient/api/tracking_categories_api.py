...
class TrackingCategoriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __tracking_categories_list(
            self,
            x_account_token,
            **kwargs
        ):
        ...
        self.tracking_categories_list = _Endpoint(
            settings={
                'response_type': (PaginatedTrackingCategoryList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/tracking-categories',
            ...
            callable=__tracking_categories_list
        )

        def __tracking_categories_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.tracking_categories_retrieve = _Endpoint(
            settings={
                'response_type': (TrackingCategory,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/tracking-categories/{id}',
            ...
            api_client=api_client,
            callable=__tracking_categories_retrieve
        )
