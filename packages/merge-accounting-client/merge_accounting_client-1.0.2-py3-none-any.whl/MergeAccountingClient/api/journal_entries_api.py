...
class JournalEntriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.journal_entries_create = _Endpoint(
            settings={
                'response_type': (JournalEntryResponse,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/journal-entries',
            ...
            callable=__journal_entries_create
        )

        def __journal_entries_list(
            self,
            x_account_token,
            **kwargs
        ):
        ...
        self.journal_entries_list = _Endpoint(
            settings={
                'response_type': (PaginatedJournalEntryList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/journal-entries',
        ...
        self.journal_entries_retrieve = _Endpoint(
            settings={
                'response_type': (JournalEntry,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/journal-entries/{id}',
            ...
            api_client=api_client,
            callable=__journal_entries_retrieve
        )
