...
class CashFlowStatementsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __cash_flow_statements_list(
            self,
            x_account_token,
            **kwargs
        ):
        ...
        self.cash_flow_statements_list = _Endpoint(
            settings={
                'response_type': (PaginatedCashFlowStatementList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/cash-flow-statements',
            ...
            callable=__cash_flow_statements_list
        )

        def __cash_flow_statements_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.cash_flow_statements_retrieve = _Endpoint(
            settings={
                'response_type': (CashFlowStatement,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/cash-flow-statements/{id}',
            ...
            api_client=api_client,
            callable=__cash_flow_statements_retrieve
        )
