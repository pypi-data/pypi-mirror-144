...
class PaymentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.payments_list = _Endpoint(
            settings={
                'response_type': (PaginatedPaymentList,),
                'auth': [
                    'tokenAuth'
                ],
            ...
            callable=__payments_list
        )

        def __payments_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.payments_retrieve = _Endpoint(
            settings={
