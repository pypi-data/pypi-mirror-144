...
class TaxRatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.tax_rates_list = _Endpoint(
            settings={
                'response_type': (PaginatedTaxRateList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/tax-rates',
            ...
            callable=__tax_rates_list
        )

        def __tax_rates_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.tax_rates_retrieve = _Endpoint(
            settings={
                'response_type': (TaxRate,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/tax-rates/{id}',
