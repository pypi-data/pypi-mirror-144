...
class CompanyInfoApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.company_info_list = _Endpoint(
            settings={
                'response_type': (PaginatedCompanyInfoList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/company-info',
            ...
            callable=__company_info_list
        )

        def __company_info_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.company_info_retrieve = _Endpoint(
            settings={
                'response_type': (CompanyInfo,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/company-info/{id}',
            ...
            api_client=api_client,
            callable=__company_info_retrieve
        )
