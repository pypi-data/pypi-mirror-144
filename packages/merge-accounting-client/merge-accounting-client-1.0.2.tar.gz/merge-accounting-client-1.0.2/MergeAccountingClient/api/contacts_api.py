...
class ContactsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contacts_list = _Endpoint(
            settings={
                'response_type': (PaginatedContactList,),
                'auth': [
                    'tokenAuth'
                ],
            ...
            callable=__contacts_list
        )

        def __contacts_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.contacts_retrieve = _Endpoint(
            settings={
                'response_type': (Contact,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/contacts/{id}',
