    ...
    def __init__(self, api_client=None):
        ...
        def __income_statements_list(
            ...
            **kwargs
            ...
            >>> thread = api.income_statements_list(x_account_token, async_req=True)
            >>> result = thread.get()
        ...
        self.income_statements_list = _Endpoint(
            settings={
                'response_type': (PaginatedIncomeStatementList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/income-statements',
            ...
            callable=__income_statements_list
        )

        def __income_statements_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
            ...
            >>> thread = api.income_statements_retrieve(x_account_token, id, async_req=True)
            >>> result = thread.get()
        ...
        self.income_statements_retrieve = _Endpoint(
            settings={
                'response_type': (IncomeStatement,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/income-statements/{id}',
            ...
            api_client=api_client,
            callable=__income_statements_retrieve
        )
