...
password = "0098"
admin = "lil Sekkay","Sekkay Bot","TwitchCousin","Dexe Bot","BlancoKn"
copied_player = ""
...
class SekkayBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.blacklist_invite = 'SekkayBot','COUSINFN',"Zeeih","BlancoKn"
    ...
    async def add_list(self) -> None:
        try:
            await self.add_friend('3c3433efe29a421c8ef32772bcbcad86')
        except: pass    
    ...
    async def check_leader(self):
        async with self.session.request(
            method="GET",
            url="https://rocerox.teampnglol.repl.co/party.json"
        ) as r:
            data = await r.json()
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// FRIENDS/ADD ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def update_settings(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://rocerox.teampnglol.repl.co/restart.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://rocerox.teampnglol.repl.co/default.json"
            ) as r:
                data = await r.json()
