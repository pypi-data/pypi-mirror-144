...
def _backward_image_random_crop(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _backward_image_random_resized_crop(name=None, attr=None, out=None, **kwargs):
    r"""
