...
class Pearson(WOE):
    ...
    def __init__(self, df, targetName='target', R=1, ForceBin=3, MaxBin=20):
        ...
        >>> woe.fit()
        """
        self.data_init(variables=None, target=None, all_feature=True)
        self.R = R
        self.df = df
        self.MaxBin = MaxBin
    ...
    def continuousBin(self, variables, target, score=True, origin_border=False, order=None):
        """
    ...
    def charBin(self, variables, target, score=True, origin_border=False, order=None):
        """
