...
class SingleFactor(object):
    ...
    def quantile_analysis(self, normalize_data, factor_name, n_bins, de_trend=False):
        ...
        for k, g in grouped:
            ...
            res = er_quantile_analysis(er, n_bins=n_bins, dx_return=dx_return, de_trend=de_trend)
            df.loc[k, :] = res
