...
from .XunProxyPool import ReachMaxException

REQUEST_SUCCESS = 0
REQUEST_TOO_QUICK = 1

logger = logging.getLogger("pool.kuaipool")


class KuaiProxyPool(IpPool):
    ...
    def _load_ip(self):
        logger.info("load ip overload from kuaidaili")
        flag = None
        res = None
    ...
    def start(self):
        logger.info("starting kuaiproxy pool")
