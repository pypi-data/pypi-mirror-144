...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".floating-window {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n\n  position: absolute;\n  z-index: 8;\n\n  border-radius: 5px;\n  overflow: hidden;\n  box-shadow: -1px 1px 3px hsla(0, 0%, 0%, 0.2), -1px 1px 20px hsla(0, 0%, 0%, 0.25);\n  background-color: white;\n\n  min-width: 270px;\n  min-height: 140px;\n  resize: both;\n}\n\n.floating-window .floating-header {\n  min-height: 24px;\n  width: 100%;\n  cursor: move;\n  background-color: var(--jp-layout-color4);\n  color: var(--md-grey-200);\n  border: 1px solid var(--jp-layout-color4);\n\n  border-top-right-radius: 5px;\n  border-top-left-radius: 5px;\n\n  position: relative;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.floating-window .sticky-content {\n  height: calc(100% - 24px);\n\n  border-bottom-right-radius: 5px;\n  border-bottom-left-radius: 5px;\n}\n\n.floating-window .button-group {\n  position: absolute;\n  right: 6px;\n  height: 100%;\n\n  display: flex;\n  flex-direction: row;\n}\n\n.floating-window .button-group svg {\n  fill: var(--md-grey-400);\n  color: var(--md-grey-400);\n  display: block;\n  height: 18px;\n  width: 18px;\n  margin: 0 auto;\n}\n\n.floating-window .header-button {\n  cursor: pointer;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  padding: 0 2px;\n}\n\n.floating-window .header-button:hover svg {\n  fill: var(--md-grey-200);\n  color: var(--md-grey-200);\n}\n\n.floating-window .header-button:active svg {\n  fill: var(--md-grey-50);\n  color: var(--md-grey-50);\n}\n\n.floating-placeholder {\n  width: 100%;\n  height: 100%;\n  background-color: var(--jp-layout-color1);\n\n  font-size: 1.5em;\n  font-weight: 400;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.floating-placeholder .placeholder-label {\n  text-align: center;\n  margin: 10px 10px 30px 10px;\n  color: var(--jp-ui-font-color2);\n  pointer-events: none;\n}\n\n.floating-placeholder .svg-icon {\n  width: 2em;\n  height: 2em;\n  fill: var(--md-grey-400);\n  pointer-events: none;\n}\n\n.placeholder-bottom-container {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 5px;\n}\n\n.placeholder-bottom-container .button {\n  border: 1px solid hsl(0, 0%, 85.9%);\n  height: 22px;\n}\n\n.placeholder-select-container {\n  position: relative;\n}\n\n.floating-window .sticky-content .button {\n  color: var(--jp-ui-font-color0);\n  background-color: var(--jp-layout-color1);\n  border: 1px solid var(--jp-layout-color1);\n  cursor: pointer;\n\n  padding: 0px 5px;\n  text-align: center;\n  white-space: nowrap;\n  border-radius: .375em;\n  box-shadow: none;\n\n  display: inline-flex;\n  justify-content: flex-start;\n  align-items: center;\n  position: relative;\n}\n\n.floating-window  .sticky-content .button:hover {\n  background-color: var(--jp-layout-color2);\n}", "",{"version":3,"sources":["webpack://./style/floating.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;;EAEvB,kBAAkB;EAClB,UAAU;;EAEV,kBAAkB;EAClB,gBAAgB;EAChB,kFAAkF;EAClF,uBAAuB;;EAEvB,gBAAgB;EAChB,iBAAiB;EACjB,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,WAAW;EACX,YAAY;EACZ,yCAAyC;EACzC,yBAAyB;EACzB,yCAAyC;;EAEzC,4BAA4B;EAC5B,2BAA2B;;EAE3B,kBAAkB;EAClB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,yBAAyB;;EAEzB,+BAA+B;EAC/B,8BAA8B;AAChC;;AAEA;EACE,kBAAkB;EAClB,UAAU;EACV,YAAY;;EAEZ,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,wBAAwB;EACxB,yBAAyB;EACzB,cAAc;EACd,YAAY;EACZ,WAAW;EACX,cAAc;AAChB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,cAAc;AAChB;;AAEA;EACE,wBAAwB;EACxB,yBAAyB;AAC3B;;AAEA;EACE,uBAAuB;EACvB,wBAAwB;AAC1B;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,yCAAyC;;EAEzC,gBAAgB;EAChB,gBAAgB;;EAEhB,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;EAClB,2BAA2B;EAC3B,+BAA+B;EAC/B,oBAAoB;AACtB;;AAEA;EACE,UAAU;EACV,WAAW;EACX,wBAAwB;EACxB,oBAAoB;AACtB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,QAAQ;AACV;;AAEA;EACE,mCAAmC;EACnC,YAAY;AACd;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,+BAA+B;EAC/B,yCAAyC;EACzC,yCAAyC;EACzC,eAAe;;EAEf,gBAAgB;EAChB,kBAAkB;EAClB,mBAAmB;EACnB,qBAAqB;EACrB,gBAAgB;;EAEhB,oBAAoB;EACpB,2BAA2B;EAC3B,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,yCAAyC;AAC3C","sourcesContent":[".floating-window {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n\n  position: absolute;\n  z-index: 8;\n\n  border-radius: 5px;\n  overflow: hidden;\n  box-shadow: -1px 1px 3px hsla(0, 0%, 0%, 0.2), -1px 1px 20px hsla(0, 0%, 0%, 0.25);\n  background-color: white;\n\n  min-width: 270px;\n  min-height: 140px;\n  resize: both;\n}\n\n.floating-window .floating-header {\n  min-height: 24px;\n  width: 100%;\n  cursor: move;\n  background-color: var(--jp-layout-color4);\n  color: var(--md-grey-200);\n  border: 1px solid var(--jp-layout-color4);\n\n  border-top-right-radius: 5px;\n  border-top-left-radius: 5px;\n\n  position: relative;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.floating-window .sticky-content {\n  height: calc(100% - 24px);\n\n  border-bottom-right-radius: 5px;\n  border-bottom-left-radius: 5px;\n}\n\n.floating-window .button-group {\n  position: absolute;\n  right: 6px;\n  height: 100%;\n\n  display: flex;\n  flex-direction: row;\n}\n\n.floating-window .button-group svg {\n  fill: var(--md-grey-400);\n  color: var(--md-grey-400);\n  display: block;\n  height: 18px;\n  width: 18px;\n  margin: 0 auto;\n}\n\n.floating-window .header-button {\n  cursor: pointer;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  padding: 0 2px;\n}\n\n.floating-window .header-button:hover svg {\n  fill: var(--md-grey-200);\n  color: var(--md-grey-200);\n}\n\n.floating-window .header-button:active svg {\n  fill: var(--md-grey-50);\n  color: var(--md-grey-50);\n}\n\n.floating-placeholder {\n  width: 100%;\n  height: 100%;\n  background-color: var(--jp-layout-color1);\n\n  font-size: 1.5em;\n  font-weight: 400;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.floating-placeholder .placeholder-label {\n  text-align: center;\n  margin: 10px 10px 30px 10px;\n  color: var(--jp-ui-font-color2);\n  pointer-events: none;\n}\n\n.floating-placeholder .svg-icon {\n  width: 2em;\n  height: 2em;\n  fill: var(--md-grey-400);\n  pointer-events: none;\n}\n\n.placeholder-bottom-container {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 5px;\n}\n\n.placeholder-bottom-container .button {\n  border: 1px solid hsl(0, 0%, 85.9%);\n  height: 22px;\n}\n\n.placeholder-select-container {\n  position: relative;\n}\n\n.floating-window .sticky-content .button {\n  color: var(--jp-ui-font-color0);\n  background-color: var(--jp-layout-color1);\n  border: 1px solid var(--jp-layout-color1);\n  cursor: pointer;\n\n  padding: 0px 5px;\n  text-align: center;\n  white-space: nowrap;\n  border-radius: .375em;\n  box-shadow: none;\n\n  display: inline-flex;\n  justify-content: flex-start;\n  align-items: center;\n  position: relative;\n}\n\n.floating-window  .sticky-content .button:hover {\n  background-color: var(--jp-layout-color2);\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
//# sourceMappingURL=style_index_js.66c44dc1308b5e978fcd.js.map