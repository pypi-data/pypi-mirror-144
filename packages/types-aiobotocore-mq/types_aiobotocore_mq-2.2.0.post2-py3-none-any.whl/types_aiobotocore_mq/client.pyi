...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/)
...
class MQClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#exceptions)
        """
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#can_paginate)
        """
    async def create_broker(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#create_broker)
        """
    async def create_configuration(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#create_configuration)
        """
    async def create_tags(self, *, ResourceArn: str, Tags: Mapping[str, str] = ...) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#create_tags)
        """
    async def create_user(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#create_user)
        """
    async def delete_broker(self, *, BrokerId: str) -> DeleteBrokerResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#delete_broker)
        """
    async def delete_tags(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#delete_tags)
        """
    async def delete_user(self, *, BrokerId: str, Username: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#delete_user)
        """
    async def describe_broker(self, *, BrokerId: str) -> DescribeBrokerResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#describe_broker)
        """
    async def describe_broker_engine_types(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#describe_broker_engine_types)
        """
    async def describe_broker_instance_options(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#describe_broker_instance_options)
        """
    async def describe_configuration(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#describe_configuration)
        """
    async def describe_configuration_revision(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#describe_configuration_revision)
        """
    async def describe_user(self, *, BrokerId: str, Username: str) -> DescribeUserResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#describe_user)
        """
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#generate_presigned_url)
        """
    async def list_brokers(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#list_brokers)
        """
    async def list_configuration_revisions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#list_configuration_revisions)
        """
    async def list_configurations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#list_configurations)
        """
    async def list_tags(self, *, ResourceArn: str) -> ListTagsResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#list_tags)
        """
    async def list_users(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#list_users)
        """
    async def reboot_broker(self, *, BrokerId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#reboot_broker)
        """
    async def update_broker(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#update_broker)
        """
    async def update_configuration(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#update_configuration)
        """
    async def update_user(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#update_user)
        """
    def get_paginator(self, operation_name: Literal["list_brokers"]) -> ListBrokersPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mq/client/#get_paginator)
        """
