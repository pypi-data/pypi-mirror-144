...
class ProjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.projects_retrieve = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__projects_retrieve
        )

        def __projects_users_list(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.projects_users_list = _Endpoint(
            settings={
                'response_type': (PaginatedUserList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/projects/{id}/users',
            ...
            api_client=api_client,
            callable=__projects_users_list
        )
