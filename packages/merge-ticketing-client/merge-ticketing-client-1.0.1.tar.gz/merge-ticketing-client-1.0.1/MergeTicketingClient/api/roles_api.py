    ...
    def __init__(self, api_client=None):
        ...
        def __roles_list(
            ...
            **kwargs
            ...
            Returns a list of `Role` objects.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.roles_list(x_account_token, async_req=True)
            >>> result = thread.get()
        ...
        self.roles_list = _Endpoint(
            settings={
                'response_type': (PaginatedRoleList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/roles',
            ...
            callable=__roles_list
        )

        def __roles_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ):
            """roles_retrieve  # noqa: E501

            Returns a `Role` object with the given `id`.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.roles_retrieve(x_account_token, id, async_req=True)
            >>> result = thread.get()
        ...
        self.roles_retrieve = _Endpoint(
            settings={
                'response_type': (Role,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/roles/{id}',
