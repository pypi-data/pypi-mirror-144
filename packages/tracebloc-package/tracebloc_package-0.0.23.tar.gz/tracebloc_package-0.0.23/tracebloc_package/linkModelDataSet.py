...
class LinkModelDataSet:
    ...
    def __init__(self, modelId, datasetId, token, weights, url=""):
        self.__url = url
    ...
    def validation_split(self, validation_split: float):
        ...
        if type(validation_split) == float and 0.0 <= validation_split <= 1.0:
            ...
            print("Invalid input type or out of range[0,1] for validation_split\n\n")
    ...
    def modelCheckpointCallback(self, monitor: str, save_best_only: bool):
        ...
        if type(monitor) == str and type(save_best_only) == bool:
            ...
            print(
                "Invalid datatype for arguments given for modelCheckpointCallback\n\n"
            )
    ...
    def earlystopCallback(self, monitor: str, patience: int):
        ...
        if type(monitor) == str and type(patience) == int:
            ...
            print("Invalid datatype for arguments given for earlystopCallback\n\n")
    ...
    def create(self):
        ...
        if duplication:
            ...
            if re.status_code == 201:
                ...
                print(text, "\n")
                explink = (
                    "https://dev.tracebloc.io/experiments/"
                    + self.__datasetId
                    + "/"
