...
class Personnel(Base):
    ...
    # Адрес проживания
    address = Column('personal_adress', String())

    # Рабочий адрес
    work_address = Column('personal_work_adress', String())
    ...
    # Серия документа
    document_series = Column('personal_document_series', String())

    # Номер документа
    document_number = Column('personal_document_number', String())
    ...
    # Гражданство
    citizenship_id = Column(ForeignKey('univer_citizenship.citizenship_id'))
    citizenship = relationship('Citizenship')
