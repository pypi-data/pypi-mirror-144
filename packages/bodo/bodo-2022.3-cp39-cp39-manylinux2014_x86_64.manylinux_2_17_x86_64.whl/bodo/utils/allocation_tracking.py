...
def get_allocation_stats():
    rgemn__mipxc = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    pjai__qjyw, zha__eca, dtv__hydej, mxz__loedy = 0, 0, 0, 0
    for tyu__nqii in rgemn__mipxc:
        pjai__qjyw += tyu__nqii[0]
        zha__eca += tyu__nqii[1]
        dtv__hydej += tyu__nqii[2]
        mxz__loedy += tyu__nqii[3]
    return pjai__qjyw, zha__eca, dtv__hydej, mxz__loedy
