...
array_op_describe_parallel = bodo.jit(distributed=['arr'])(bodo.libs.
    array_ops.array_op_describe_impl)
array_op_describe_parallel_dt = bodo.jit(distributed=['arr'])(bodo.libs.
    array_ops.array_op_describe_dt_impl)
