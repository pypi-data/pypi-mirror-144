...
def get_allocation_stats():
    qqu__cjp = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    srd__fbl, jgqqq__zkrhs, mae__wkw, tmvex__njxen = 0, 0, 0, 0
    for flbuz__qxcg in qqu__cjp:
        srd__fbl += flbuz__qxcg[0]
        jgqqq__zkrhs += flbuz__qxcg[1]
        mae__wkw += flbuz__qxcg[2]
        tmvex__njxen += flbuz__qxcg[3]
    return srd__fbl, jgqqq__zkrhs, mae__wkw, tmvex__njxen
