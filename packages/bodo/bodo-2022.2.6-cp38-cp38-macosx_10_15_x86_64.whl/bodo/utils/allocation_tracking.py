...
def get_allocation_stats():
    lav__asm = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    awoyg__bie, giytg__myzus, dnf__bdxh, tgx__vsobg = 0, 0, 0, 0
    for zlmd__hqo in lav__asm:
        awoyg__bie += zlmd__hqo[0]
        giytg__myzus += zlmd__hqo[1]
        dnf__bdxh += zlmd__hqo[2]
        tgx__vsobg += zlmd__hqo[3]
    return awoyg__bie, giytg__myzus, dnf__bdxh, tgx__vsobg
