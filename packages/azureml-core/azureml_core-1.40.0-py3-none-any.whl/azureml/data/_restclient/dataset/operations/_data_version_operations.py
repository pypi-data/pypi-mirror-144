...
class DataVersionOperations(object):
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        """
        cls = kwargs.pop(
            'cls', None)  # type: ClsType["_models.DataVersionEntity"]
        error_map = {
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        """
        cls = kwargs.pop(
            'cls', None)  # type: ClsType["_models.PaginatedDataVersionEntityList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def delete(
        ...
        **kwargs  # type: Any
        ...
        """
        cls = kwargs.pop(
            'cls', None)  # type: ClsType["_models.HttpResponseMessage"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        deserialized = self._deserialize(
            'HttpResponseMessage', pipeline_response)
    ...
    get_by_asset_id.metadata = {
        'url': '/data/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/dataversion/getByAssetId'}  # type: ignore
    ...
    def create_unregistered_input_data(
        ...
        **kwargs  # type: Any
        ...
        """
        cls = kwargs.pop(
            'cls', None)  # type: ClsType["_models.DataContainerEntity"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    create_unregistered_input_data.metadata = {
        'url': '/data/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/dataversion/createUnregisteredInput'}  # type: ignore
    ...
    create_unregistered_output_data.metadata = {
        'url': '/data/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/dataversion/createUnregisteredOutput'}  # type: ignore
    ...
    registered_existing_data.metadata = {
        'url': '/data/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/dataversion/registerExisting'}  # type: ignore
    ...
    def batch_get_resolved_uris(
        ...
        **kwargs  # type: Any
        ...
        """
        cls = kwargs.pop(
            'cls', None)  # type: ClsType["_models.BatchDataUriResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    batch_get_resolved_uris.metadata = {
        'url': '/data/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/dataversion/batchGetResolvedUris'}  # type: ignore
