...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, url=None, pulp_labels=None, client_key=None, tls_validation=None, headers=None, name=None, rate_limit=None, proxy_username=None, proxy_url=None, client_cert=None, connect_timeout=None, ca_cert=None, download_concurrency=None, max_retries=None, password=None, total_timeout=None, sock_read_timeout=None, proxy_password=None, username=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
