...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, pulp_labels=None, pulp_created=None, tls_validation=None, headers=None, name=None, pulp_href=None, rate_limit=None, proxy_url=None, client_cert=None, connect_timeout=None, ca_cert=None, download_concurrency=None, max_retries=None, total_timeout=None, sock_read_timeout=None, pulp_last_updated=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
