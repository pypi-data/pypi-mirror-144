...
def vector2gif(data: Vector, filename: str, transpose:bool=False, clip:int=100, frame_axis=-1, frame_interval:float=.25):
    """
    ...
    """
    assert data.ndim == 3, "Data has to be a 3D vector"
