...
class DataAwsCloudfrontRealtimeLogConfig(
    ...
    def endpoint(
        ...
        :param index: -
        '''
        return typing.cast("DataAwsCloudfrontRealtimeLogConfigEndpoint", jsii.invoke(self, "endpoint", [index]))
...
class DataAwsCloudfrontRealtimeLogConfigEndpoint(
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="kinesisStreamConfig")
    def kinesis_stream_config(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "kinesisStreamConfig"))
