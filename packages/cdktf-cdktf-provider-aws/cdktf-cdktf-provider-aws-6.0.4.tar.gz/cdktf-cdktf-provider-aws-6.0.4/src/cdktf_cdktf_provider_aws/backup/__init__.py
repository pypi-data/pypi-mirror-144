...
class DataAwsBackupFramework(
    ...
    @jsii.member(jsii_name="control")
    def control(self, index: builtins.str) -> "DataAwsBackupFrameworkControl":
        '''
        :param index: -
        '''
        return typing.cast("DataAwsBackupFrameworkControl", jsii.invoke(self, "control", [index]))
...
class DataAwsBackupFrameworkControl(
    ...
    def input_parameter(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "inputParameter"))
    ...
    def scope(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "scope"))
...
class DataAwsBackupReportPlan(
    ...
    def report_delivery_channel(
        ...
        :param index: -
        '''
        return typing.cast("DataAwsBackupReportPlanReportDeliveryChannel", jsii.invoke(self, "reportDeliveryChannel", [index]))
    ...
    def report_setting(
        ...
        :param index: -
        '''
        return typing.cast("DataAwsBackupReportPlanReportSetting", jsii.invoke(self, "reportSetting", [index]))
