...
class DataAwsElasticsearchDomainAutoTuneOptions(
    ...
    def maintenance_schedule(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "maintenanceSchedule"))
...
class DataAwsElasticsearchDomainAutoTuneOptionsMaintenanceSchedule(
    ...
    def duration(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "duration"))
...
class DataAwsElasticsearchDomainClusterConfig(
    ...
    def cold_storage_options(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "coldStorageOptions"))
    ...
    def zone_awareness_config(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "zoneAwarenessConfig"))
