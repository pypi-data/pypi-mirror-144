...
class ServiceDiscoveryServiceDnsConfigOutputReference(
    ...
    def dns_records(
        ...
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List[ServiceDiscoveryServiceDnsConfigDnsRecords]], jsii.get(self, "dnsRecords"))

    @dns_records.setter
    def dns_records(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List[ServiceDiscoveryServiceDnsConfigDnsRecords]],
    ) -> None:
