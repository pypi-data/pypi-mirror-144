...
class DataAwsAcmpcaCertificateAuthorityRevocationConfiguration:
    def __init__(
        self,
        *,
        crl_configuration: typing.Optional[typing.Union[typing.Sequence["DataAwsAcmpcaCertificateAuthorityRevocationConfigurationCrlConfiguration"], cdktf.IResolvable]] = None,
    ) -> None:
        '''
    ...
    def crl_configuration(
        self,
    ) -> typing.Optional[typing.Union[typing.List["DataAwsAcmpcaCertificateAuthorityRevocationConfigurationCrlConfiguration"], cdktf.IResolvable]]:
        '''crl_configuration block.
        ...
        '''
        result = self._values.get("crl_configuration")
        return typing.cast(typing.Optional[typing.Union[typing.List["DataAwsAcmpcaCertificateAuthorityRevocationConfigurationCrlConfiguration"], cdktf.IResolvable]], result)
