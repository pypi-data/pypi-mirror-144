...
class DataAwsResourcegroupstaggingapiResources(
    ...
    def tag_filter(
        self,
    ) -> typing.Union[cdktf.IResolvable, typing.List["DataAwsResourcegroupstaggingapiResourcesTagFilter"]]:
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["DataAwsResourcegroupstaggingapiResourcesTagFilter"]], jsii.get(self, "tagFilter"))

    @tag_filter.setter
    def tag_filter(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List["DataAwsResourcegroupstaggingapiResourcesTagFilter"]],
    ) -> None:
...
class DataAwsResourcegroupstaggingapiResourcesResourceTagMappingList(
    ...
    def compliance_details(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "complianceDetails"))
