...
class ProjectDB(DynamoModel):
    ...
    def update(self):
        AuthDynamos.projects.update_item(self.get_pkey_values(), self.get_changed())
...
class DefaultLimitsDB(DynamoModel):
    ...
    def update(self):
        AuthDynamos.default_limits.update_item(self.get_pkey_values(), self.get_changed())
...
class ProjectMembersDB(DynamoModel):
    ...
    def update(self):
        AuthDynamos.project_members.update_item(self.get_pkey_values(), self.get_changed())
...
class ProjectLimitsDB(DynamoModel):
    ...
    def update(self):
        AuthDynamos.project_limits.update_item(self.get_pkey_values(), self.get_changed())
...
class StackAdministratorsDB(DynamoModel):
    ...
    def update(self):
        AuthDynamos.stack_administrators.update_item(self.get_pkey_values(), self.get_changed())
...
class KeysDB(DynamoModel):
    ...
    def update(self):
        AuthDynamos.keys.update_item(self.get_pkey_values(), self.get_changed())
