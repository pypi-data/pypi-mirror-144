...
from .tree import (
    ...
    Range, Regex, SearchField, UnknownOperation, Word, NotnOperation,
...
def p_expression_notn(p):
    '''expression : expression NOTN_OP expression'''
    p[0] = create_operation(NotnOperation, p[1], p[3], op_tail=p[2].tail)
    head_tail.binary_operation(p, op_tail=p[2].tail)
