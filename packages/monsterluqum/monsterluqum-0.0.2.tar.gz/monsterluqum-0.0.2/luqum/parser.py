...
from .tree import (
    ...
    Range, Regex, SearchField, UnknownOperation, Word, NotOperation,
...
def p_expression_not(p):
    '''expression : expression AND_NOT expression'''
    p[0] = create_operation(NotOperation, p[1], p[3], op_tail=p[2].tail)
    head_tail.binary_operation(p, op_tail=p[2].tail)
