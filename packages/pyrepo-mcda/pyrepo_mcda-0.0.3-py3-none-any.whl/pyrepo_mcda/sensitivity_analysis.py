...
class Sensitivity_analysis_weights():
    ...
    def __call__(self, matrix, weights, types, percentages, mcda_name, j, dir_list):
        """
        ...
        -----------
            ...
            dir_list : list
                list with directions (signs) of criterion weight modification. 1 denotes increasing,
                and -1 denotes decreasing weight value
        ...
        return Sensitivity_analysis_weights._sensitivity_analysis_weights(self, matrix, weights, types, percentages, mcda_name, list_alt_names, j, dir_list)
    ...
    @staticmethod
    def _sensitivity_analysis_weights(self, matrix, weights, types, percentages, mcda_name, list_alt_names, j, dir_list):
