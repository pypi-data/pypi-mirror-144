...
class Sensitivity_analysis_weights_values():
    ...
    def __call__(self, matrix, weight_values, types, method, j):
        ...
        -----------
            ...
            weight_values : ndarray
                Vector with values to be set as the weight of chosen criterion in the sensitivity analysis procedure.
    ...
    def _change_weights(self, matrix, weight_value, j):
        ...
        -----------
            ...
            weight_value : float
                Value to be set as the weight of chosen criterion with index j.
        ...
        print('Sum of weights: ', np.sum(new_weights))
        return new_weights
