...
# TODO: delete the unused root parameter from BaseDecisionTree for cleaner scaffolded code. (v0.4.0)
# TODO: move data validating and cleaning to a separarte class from DecisionTreeWriter and add better validating and cleaning methods (v0.4.1)
