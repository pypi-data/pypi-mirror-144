...
class BaseRequest(HttpClient):
    ...
    def _uri(self):
        ...
        url = f'https://{self._service}-dot-{self._project}.appspot.com' if self._service else local_url
        return f'{url}{self._path}'
...
class Tasks(BaseTasks):
    ...
    def __init__(self,
        ...
        super().__init__(service, path, access_token, project, location, queue, in_seconds)
