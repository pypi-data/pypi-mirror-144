__all__ = ('LoanPoint', 'ClosedLoanPoint', 'LoanPaymentPoint')
...
class LoanPaymentResponseContract(LoanPaymentReadContract):
    pass
...
class LoanPaymentPoint(ListPointMixin, CreatePointMixin, ContractPoint):
    ...
    _response_contract = LoanPaymentResponseContract
