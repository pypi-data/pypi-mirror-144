...
class Host(OpenApiObject):
    ...
    def __init__(self, parent=None, name=None, address=None, prefix=24, host_type=None):
    ...
    def host_type(self):
        ...
        Optional host type, if fabric is rendered on physical box.. - external for hosts/servers physically connected to front panel ports. - internal_traffic_sink for an emulated server that acts as a traffic sink (i.e. packets sent to its IP address will be routed through the fabric)
...
class HostIter(OpenApiIter):
    ...
    def host(self, name=None, address=None, prefix=24, host_type=None):
        # type: (str,str,int,Union[Literal["external"], Literal["internal_traffic_sink"]]) -> HostIter
        ...
        Returns: HostIter
        """
        item = Host(parent=self._parent, name=name, address=address, prefix=prefix, host_type=host_type)
        self._add(item)
        return self

    def add(self, name=None, address=None, prefix=24, host_type=None):
        # type: (str,str,int,Union[Literal["external"], Literal["internal_traffic_sink"]]) -> Host
...
class FabricPodProfile(OpenApiObject):
    ...
    def racks(self):
        ...
        The racks in the pod

        Returns: FabricRackIter
        """
        return self._get_property('racks', FabricRackIter, self._parent, self._choice)
...
class FabricRack(OpenApiObject):
    ...
    def __init__(self, parent=None, count=1, rack_profile_name=None):
        super(FabricRack, self).__init__()
        self._parent = parent
        self._set_property('count', count)
        self._set_property('rack_profile_name', rack_profile_name)
    ...
    def count(self):
        ...
        number of racks (and thus ToRs) that will share the same profile
    ...
    @property
    def rack_profile_name(self):
        # type: () -> str
        """rack_profile_name getter

        The names of rack profiles associated with the rack(s). . x-constraint:. - #/components/schemas/RackProfile/properties/name. 

        Returns: str
        """
        return self._get_property('rack_profile_name')

    @rack_profile_name.setter
    def rack_profile_name(self, value):
        """rack_profile_name setter
        ...
        value: str
        """
        self._set_property('rack_profile_name', value)


class FabricRackIter(OpenApiIter):
    __slots__ = ('_parent', '_choice')

    _GETITEM_RETURNS_CHOICE_OBJECT = False

    def __init__(self, parent=None, choice=None):
        super(FabricRackIter, self).__init__()
        self._parent = parent
        self._choice = choice

    def __getitem__(self, key):
        # type: (str) -> Union[FabricRack]
        return self._getitem(key)
    ...
    def rack(self, count=1, rack_profile_name=None):
        # type: (int,str) -> FabricRackIter
        """Factory method that creates an instance of the FabricRack class

        TBD

        Returns: FabricRackIter
        """
        item = FabricRack(parent=self._parent, count=count, rack_profile_name=rack_profile_name)
        self._add(item)
        return self

    def add(self, count=1, rack_profile_name=None):
        # type: (int,str) -> FabricRack
        """Add method that creates and returns an instance of the FabricRack class
...
class FabricRackProfile(OpenApiObject):
    ...
    def qos_profile_name(self):
        ...
        The name of a qos profile associated with the ToR(s) of this rack. . x-constraint:. - #/components/schemas/QosProfile/properties/name. 
...
class FabricRackProfileIter(OpenApiIter):
    ...
    def rackprofile(self, name=None, tor_mode=None, uplink_ecmp_mode=None, qos_profile_name=None, tor_to_pod_oversubscription=None):
        # type: (str,Union[Literal["layer2"], Literal["layer3"]],Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],str,str) -> FabricRackProfileIter
        ...
        Returns: FabricRackProfileIter
        """
        item = FabricRackProfile(parent=self._parent, name=name, tor_mode=tor_mode, uplink_ecmp_mode=uplink_ecmp_mode, qos_profile_name=qos_profile_name, tor_to_pod_oversubscription=tor_to_pod_oversubscription)
        self._add(item)
        return self

    def add(self, name=None, tor_mode=None, uplink_ecmp_mode=None, qos_profile_name=None, tor_to_pod_oversubscription=None):
        # type: (str,Union[Literal["layer2"], Literal["layer3"]],Union[Literal["hash_3_tuple"], Literal["hash_5_tuple"], Literal["random_spray"]],str,str) -> FabricRackProfile
...
class Chaos(OpenApiObject):
    ...
    _TYPES = {
        ...
        'drop_frames': {'type': 'ChaosDropFrames'},
    } # type: Dict[str, str]
    ...
    def drop_frames(self):
        ...
        Configures the percentage of time during a 1 second period during which frames are dropped on selected linksConfigures the percentage of time during a 1 second period during which frames are dropped on selected links

        Returns: ChaosDropFrames
        """
        return self._get_property('drop_frames', ChaosDropFrames)
...
class ChaosDropFrames(OpenApiObject):
    ...
    _TYPES = {
        'configs': {'type': 'ChaosDropFramesConfigIter'},
    } # type: Dict[str, str]
    ...
    @property
    def configs(self):
        # type: () -> ChaosDropFramesConfigIter
        """configs getter

        TBD

        Returns: ChaosDropFramesConfigIter
        """
        return self._get_property('configs', ChaosDropFramesConfigIter, self._parent, self._choice)


class ChaosDropFramesConfig(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, name=None, link=None, type=None, percentage=None):
        super(ChaosDropFramesConfig, self).__init__()
        self._parent = parent
        self._set_property('name', name)
    ...
    def type(self):
        ...
        Means to express the interval in which frames are dropped, either as a percentage or min possible time
...
class ChaosDropFramesConfigIter(OpenApiIter):
    __slots__ = ('_parent', '_choice')

    _GETITEM_RETURNS_CHOICE_OBJECT = False

    def __init__(self, parent=None, choice=None):
        super(ChaosDropFramesConfigIter, self).__init__()
        self._parent = parent
        self._choice = choice

    def __getitem__(self, key):
        # type: (str) -> Union[ChaosDropFramesConfig]
        return self._getitem(key)
    ...
    def config(self, name=None, link=None, type=None, percentage=None):
        # type: (str,str,Union[Literal["min_time"], Literal["percentage_time"]],float) -> ChaosDropFramesConfigIter
        """Factory method that creates an instance of the ChaosDropFramesConfig class

        Configures the percentage of time during a 1 second period during which frames are dropped on a link

        Returns: ChaosDropFramesConfigIter
        """
        item = ChaosDropFramesConfig(parent=self._parent, name=name, link=link, type=type, percentage=percentage)
        self._add(item)
        return self

    def add(self, name=None, link=None, type=None, percentage=None):
        # type: (str,str,Union[Literal["min_time"], Literal["percentage_time"]],float) -> ChaosDropFramesConfig
        """Add method that creates and returns an instance of the ChaosDropFramesConfig class

        Configures the percentage of time during a 1 second period during which frames are dropped on a link

        Returns: ChaosDropFramesConfig
        """
        item = ChaosDropFramesConfig(parent=self._parent, name=name, link=link, type=type, percentage=percentage)
        self._add(item)
        return item
...
class Insights(OpenApiObject):
    ...
    _TYPES = {
        'port_mirroring': {'type': 'InsightsPortMirroring'},
    } # type: Dict[str, str]
    ...
    def port_mirroring(self):
        ...
        """
        return self._get_property('port_mirroring', InsightsPortMirroring)
