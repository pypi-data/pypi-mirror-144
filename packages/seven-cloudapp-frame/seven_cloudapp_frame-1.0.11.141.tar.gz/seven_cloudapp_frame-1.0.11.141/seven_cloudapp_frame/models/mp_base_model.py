...
class MPBaseModel():
    ...
    def get_key_power_list(self, store_user_nick, project_code, key_names):
        """
    ...
    def check_high_power(self, store_user_nick, project_code, key_names):
        """
        ...
        :last_editors: HuangJianYi
        """
        power_list = self.get_key_power_list(store_user_nick, project_code, key_names)
        is_power = True    
