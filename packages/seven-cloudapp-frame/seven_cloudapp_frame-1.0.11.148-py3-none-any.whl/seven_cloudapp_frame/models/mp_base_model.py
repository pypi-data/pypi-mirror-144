...
class MPBaseModel():
    ...
    def get_key_power_list(self, store_user_nick, project_code, key_names,user_type=""):
        """
        :description:  指定模块权限列表
        :param store_user_nick:商家主账号昵称
        :param project_code:项目编码
        :param key_names:权限代码，多个逗号分隔
        :param user_type:1-SAAS用户2-SAAS定制用户
        :return list: 
        :last_editors: HuangJianYi
        """
        power_list = []
    ...
    def check_high_power(self, store_user_nick, project_code, key_names,user_type=""):
        """
