...
class MatrixField(MultiValueField):
    ...
    default_error_messages = {
        'required_all_rows': _('All rows are required.'),
        'unique_answers': _('Values have to be unique.'),
    }
    ...
    def __init__(self, rows=None, columns=None, required=True, widget=Matrix,
        ...
        super().__init__(self.fields, initial=initial, help_text=help_text, required=required, label=label, *args, **kwargs)
