...
class UpgradeFrom1020To1022(UpgradeStep):
    FROM = semver.parse_version_info('10.2.0')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.2.2')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.2.0 To 10.2.2.')
    def process(self):
        # type: () -> None
