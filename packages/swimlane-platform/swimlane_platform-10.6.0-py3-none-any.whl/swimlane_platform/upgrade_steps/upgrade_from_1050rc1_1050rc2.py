...
class UpgradeFrom1050rc1To1050rc2(UpgradeStep):
    FROM = semver.parse_version_info('10.5.0-rc1')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.5.0-rc2')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.5.0-rc1 To 10.5.0-rc2')
    def process(self):
        # type: () -> None
