...
class UpgradeFrom1041To1042(UpgradeStep):
    FROM = semver.parse_version_info('10.4.1')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.4.2')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.4.1 To 10.4.2')
    def process(self):
        # type: () -> None
