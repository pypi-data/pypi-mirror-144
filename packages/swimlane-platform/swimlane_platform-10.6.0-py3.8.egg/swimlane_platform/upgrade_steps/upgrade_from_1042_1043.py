...
class UpgradeFrom1042To1043(UpgradeStep):
    FROM = semver.parse_version_info('10.4.2')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.4.3')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.4.2 To 10.4.3')
    def process(self):
        # type: () -> None
    ...
    def upgrade_image_versions(self, install_dir, dev):
        ...
        docker_compose.set('mongo:4.4.9', 'services', names.SW_MONGO, 'image')
        docker_compose.save()
