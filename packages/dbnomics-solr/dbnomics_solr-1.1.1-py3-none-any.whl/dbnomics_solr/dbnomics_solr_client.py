...
def build_dataset_solr(
    ...
    updated_at_str = None if updated_at is None else format_datetime(updated_at)
...
def format_datetime(d: date) -> str:
    ...
    If the timezone is not specified, UTC is assumed and a warning is logged.

    >>> from datetime import timedelta
    >>> format_datetime(date(2000, 1, 1))
    '2000-01-01T00:00:00Z'
    >>> format_datetime(datetime(2000, 1, 1, 5, 5, 5))
    '2000-01-01T05:05:05Z'
    >>> format_datetime(datetime(2000, 1, 1, 5, 5, 5, tzinfo=timezone.utc))
    '2000-01-01T05:05:05Z'
    >>> format_datetime(datetime(2000, 1, 1, 5, 5, 5, tzinfo=timezone(timedelta(hours=2))))
