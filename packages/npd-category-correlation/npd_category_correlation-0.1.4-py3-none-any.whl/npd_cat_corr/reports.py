...
def run_cat_report(output_dir, ticker, df):
    ...
    if use_rev:
        ...
        yy_visuals_sheet.write("F2", "Unavailable", rounded_border_format)
        yy_visuals_sheet.write("G2", "Unavailable", rounded_border_format)
        yy_visuals_sheet.write("H2", "Unavailable", percent_border_format)
    ...
    if use_profit:
        ...
        yy_visuals_sheet.write("F3", "Unavailable", rounded_border_format)
        yy_visuals_sheet.write("H3", "Unavailable", percent_border_format)
    ...
    if use_eps:
        ...
        yy_visuals_sheet.write("E4", "Unavailable", rounded_border_format)
        yy_visuals_sheet.write("F4", "Unavailable", rounded_border_format)
        yy_visuals_sheet.write("G4", "Unavailable", rounded_border_format)
        yy_visuals_sheet.write("H4", "Unavailable", percent_border_format)
