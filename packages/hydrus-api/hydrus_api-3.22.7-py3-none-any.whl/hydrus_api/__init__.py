...
class Client:
    ...
    def delete_files(self, hashes: abc.Iterable[str]) -> None:
        self._api_request("POST", self._DELETE_FILES_PATH, json={"hashes": hashes})

    def undelete_files(self, hashes: abc.Iterable[str]) -> None:
        self._api_request("POST", self._UNDELETE_FILES_PATH, json={"hashes": hashes})

    def archive_files(self, hashes: abc.Iterable[str]) -> None:
        self._api_request("POST", self._ARCHIVE_FILES_PATH, json={"hashes": hashes})

    def unarchive_files(self, hashes: abc.Iterable[str]) -> None:
        self._api_request("POST", self._UNARCHIVE_FILES_PATH, json={"hashes": hashes})
    ...
    def add_tags(
        ...
        payload: dict[str, T.Any] = {"hashes": hashes}
    ...
    def add_files_to_page(
        self, page_key: str, file_ids: T.Optional[abc.Iterable[int]], hashes: T.Optional[abc.Iterable[str]]
    ) -> None:
