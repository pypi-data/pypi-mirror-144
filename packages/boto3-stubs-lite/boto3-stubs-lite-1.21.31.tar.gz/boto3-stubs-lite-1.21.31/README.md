...
[boto3 1.21.31](https://boto3.amazonaws.com/v1/documentation/api/1.21.31/index.html)
...
- `boto3-stubs-lite[all]` - Type annotations for all 303 services.
...
- `boto3-stubs-lite[pinpoint-sms-voice-v2]` - Type annotations for
  [PinpointSMSVoiceV2](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_pinpoint_sms_voice_v2/)
  service.
