...
from notetest.flask.example1 import OkexClientAccountBalance
...
class WebsocketService(APIRouter):
    ...
    def update_channels_db(self):
        ...
        for _detail in details:
            ...
            if detail['ccy'] == 'USDT':
                continue
            session.merge(OkexWebsocketChannels(**detail))
        session.commit()
        create_all()
    ...
    def update_channels(self):
        ...
        new_channels = [eval(channel.channel_str) for channel in new_channels]
