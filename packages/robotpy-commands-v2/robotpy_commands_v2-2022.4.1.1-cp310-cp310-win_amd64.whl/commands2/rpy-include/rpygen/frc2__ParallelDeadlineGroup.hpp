    ...
    PyTrampolineCfgBase_frc2__ParallelDeadlineGroup< CfgBase>
{
    ...
    using override_base_Initialize_v = frc2::ParallelDeadlineGroup;
    using override_base_Execute_v = frc2::ParallelDeadlineGroup;
    using override_base_End_b = frc2::ParallelDeadlineGroup;
    using override_base_IsFinished_v = frc2::ParallelDeadlineGroup;
