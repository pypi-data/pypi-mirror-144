...
py::class_<typename frc2::ProfiledPIDCommand<Distance>, ProfiledPIDCommand_Trampoline, CommandBase> cls_ProfiledPIDCommand;
...
"@see ProfiledPIDController<Distance>";
  ...
  cls_ProfiledPIDCommand
      .def(py::init<frc::ProfiledPIDController<Distance >, std::function<Distance_t ( )>, std::function<State ( )>, std::function<void ( double, State )>, wpi::span<std::shared_ptr<Subsystem> >>(),
      py::arg("controller"), py::arg("measurementSource"), py::arg("goalSource"), py::arg("useOutput"), py::arg("requirements")=wpi::span<std::shared_ptr<Subsystem> >{}, release_gil(), py::doc(
...
":param requirements:      the subsystems required by this command")
      ...
      .def(py::init<frc::ProfiledPIDController<Distance >, std::function<Distance_t ( )>, std::function<Distance_t ( )>, std::function<void ( double, State )>, wpi::span<std::shared_ptr<Subsystem> >>(),
      py::arg("controller"), py::arg("measurementSource"), py::arg("goalSource"), py::arg("useOutput"), py::arg("requirements")=wpi::span<std::shared_ptr<Subsystem> >{}, release_gil(), py::doc(
    "Creates a new PIDCommand, which controls the given output with a\n"
"ProfiledPIDController.\n"
"\n"
...
":param requirements:      the subsystems required by this command")
      ...
      .def(py::init<frc::ProfiledPIDController<Distance >, std::function<Distance_t ( )>, typename frc::TrapezoidProfile<Distance >::State, std::function<void ( double, State )>, wpi::span<std::shared_ptr<Subsystem> >>(),
      py::arg("controller"), py::arg("measurementSource"), py::arg("goal"), py::arg("useOutput"), py::arg("requirements")=wpi::span<std::shared_ptr<Subsystem> >{}, release_gil(), py::doc(
    "Creates a new PIDCommand, which controls the given output with a\n"
...
":param requirements:      the subsystems required by this command")
      ...
      .def(py::init<frc::ProfiledPIDController<Distance >, std::function<Distance_t ( )>, units::unit_t<Distance >, std::function<void ( double, State )>, wpi::span<std::shared_ptr<Subsystem> >>(),
      py::arg("controller"), py::arg("measurementSource"), py::arg("goal"), py::arg("useOutput"), py::arg("requirements")=wpi::span<std::shared_ptr<Subsystem> >{}, release_gil(), py::doc(
    "Creates a new PIDCommand, which controls the given output with a\n"
"ProfiledPIDController with a constant goal.\n"
"\n"
