    ...
    PyTrampolineCfgBase_frc2__ParallelRaceGroup< CfgBase>
{
    ...
    using override_base_Initialize_v = frc2::ParallelRaceGroup;
    using override_base_Execute_v = frc2::ParallelRaceGroup;
    using override_base_End_b = frc2::ParallelRaceGroup;
    using override_base_IsFinished_v = frc2::ParallelRaceGroup;
