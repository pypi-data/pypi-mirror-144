...
py::class_<typename frc2::TrapezoidProfileCommand<Distance>, TrapezoidProfileCommand_Trampoline, CommandBase> cls_TrapezoidProfileCommand;
...
"@see TrapezoidProfile";
  ...
  cls_TrapezoidProfileCommand
      .def(py::init<frc::TrapezoidProfile<Distance >, std::function<void(State)>, wpi::span<std::shared_ptr<Subsystem> >>(),
      py::arg("profile"), py::arg("output"), py::arg("requirements")=wpi::span<std::shared_ptr<Subsystem> >{}, release_gil(), py::doc(
