...
class CartesianProductMoveSelectorConfig(org.optaplanner.core.config.heuristic.selector.move.MoveSelectorConfig['CartesianProductMoveSelectorConfig']):
    ...
    def withMoveSelectors(self, moveSelectorConfigArray: typing.List[org.optaplanner.core.config.heuristic.selector.move.MoveSelectorConfig]) -> 'CartesianProductMoveSelectorConfig': ...
...
class UnionMoveSelectorConfig(org.optaplanner.core.config.heuristic.selector.move.MoveSelectorConfig['UnionMoveSelectorConfig']):
    ...
    def withMoveSelectors(self, moveSelectorConfigArray: typing.List[org.optaplanner.core.config.heuristic.selector.move.MoveSelectorConfig]) -> 'UnionMoveSelectorConfig': ...
