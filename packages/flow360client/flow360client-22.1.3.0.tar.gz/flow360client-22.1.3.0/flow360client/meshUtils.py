...
def getBoundaryCompoundNamesFromCGNS(meshFile):
...
def validateMeshAndMeshJson(meshName, meshJson):
    ...
    if not _H5PY_AVAILABLE:
        ...
        boundaryCompoundNames = getBoundaryCompoundNamesFromCGNS(meshName)
...
def validateMeshAndCaseJson(meshName, caseJson):
    if not meshName.endswith('.cgns'):
