...
[Open documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ecr/paginators/)
...
class DescribeImageScanFindingsPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ecr/paginators/#describeimagescanfindingspaginator)
    """
...
class DescribeImagesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ecr/paginators/#describeimagespaginator)
    """
...
class DescribePullThroughCacheRulesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ecr/paginators/#describepullthroughcacherulespaginator)
    """
...
class DescribeRepositoriesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ecr/paginators/#describerepositoriespaginator)
    """
...
class GetLifecyclePolicyPreviewPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ecr/paginators/#getlifecyclepolicypreviewpaginator)
    """
...
class ListImagesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ecr/paginators/#listimagespaginator)
    """
