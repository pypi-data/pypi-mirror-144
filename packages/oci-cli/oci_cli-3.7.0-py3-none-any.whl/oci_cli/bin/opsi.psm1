...
function GetOciSubcommands_opsi() {
    $ociSubcommands = @{
        'opsi' = 'awr-hubs database-insights enterprise-manager-bridges exadata-insights host-insights operations-insights-warehouse-users operations-insights-warehouses opsi-private-endpoint work-requests'
        'opsi awr-hubs' = 'create delete get get-awr-report list list-awr-snapshots summarize-awr-sources-summaries update'
        ...
        'opsi exadata-insights' = 'add-em-external-exadata-members change create-em-external-exadata delete disable enable-em-external-exadata get list list-exadata-configurations summarize-exadata-insight-resource-capacity-trend summarize-exadata-insight-resource-capacity-trend-aggregated summarize-exadata-insight-resource-forecast-trend summarize-exadata-insight-resource-forecast-trend-aggregated summarize-exadata-insight-resource-statistics summarize-exadata-insight-resource-usage summarize-exadata-insight-resource-usage-aggregated summarize-exadata-insight-resource-utilization-insight summarize-exadata-members update-em-external-exadata'
        'opsi host-insights' = 'change create-em-external-host create-macs-external-host delete disable enable-em-external-host enable-macs-external-host get ingest-host-configuration ingest-host-metrics list list-host-configurations list-hosted-entities list-importable-agent-entities summarize-host-insight-resource-capacity-trend summarize-host-insight-resource-forecast-trend summarize-host-insight-resource-statistics summarize-host-insight-resource-usage summarize-host-insight-resource-usage-trend summarize-host-insight-resource-utilization-insight update-em-external-host update-macs-external-host'
        ...
        'opsi opsi-private-endpoint' = 'list'
...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi database-insights create-pe-comanged-database' = 'compartment-id credential-details database-id database-resource-type defined-tags deployment-type freeform-tags from-json help max-wait-seconds opsi-private-endpoint-id service-name system-tags wait-for-state wait-interval-seconds'
        ...
        'opsi host-insights list-host-configurations' = 'all compartment-id compartment-id-in-subtree defined-tag-equals defined-tag-exists em-bridge-id exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help id limit page page-size platform-type sort-by sort-order'
        'opsi host-insights list-hosted-entities' = 'all analysis-time-interval compartment-id exadata-insight-id from-json help id limit page page-size platform-type sort-by sort-order time-interval-end time-interval-start'
