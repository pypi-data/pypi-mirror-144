...
class _FWv4BatchFeatureView(FeatureView):
    ...
    def run(
        ...
        **mock_sources: Union[pandas.DataFrame, DataFrame],
        ...
        :param mock_sources: kwargs with the same expected keys as the FeatureView's inputs parameter. Each key should
            be a data source name which maps to a DataFrame.
