...
from y5gg.utils.general import colorstr, increment_path, make_divisible, non_max_suppression, save_one_box, \
...
class Detections:
    ...
    def get_predictions(self, out_format='tlbr'):
        predictions = []
        for i, (im, pred) in enumerate(zip(self.imgs, self.pred)):
            ...
            class_ids = []
            if pred.shape[0]:
                for *xyxy, conf, cls in reversed(pred):  # xyxy, confidence, class
