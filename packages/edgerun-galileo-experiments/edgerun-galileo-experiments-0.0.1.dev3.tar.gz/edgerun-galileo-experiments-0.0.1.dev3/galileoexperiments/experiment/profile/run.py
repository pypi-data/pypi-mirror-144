...
from galileo.shell.shell import RoutingTableHelper, init, Galileo
...
def run_profiling_workload(workload_config: ProfilingWorkloadConfiguration):
    ...
    image_url = workload_config.params['service']['image_url']
    galileo: Galileo = g['g']
    client_group = None
...
def run_profile_experiment(config: ProfilingExperimentConfiguration):
    pod_names = None
