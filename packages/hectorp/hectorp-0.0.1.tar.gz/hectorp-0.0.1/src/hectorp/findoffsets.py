...
def create_ctl_file(station,noisemodels):
...
def main():
    ...
    print("\n***************************************")
    print("    findoffsets, version 0.0.1")
    print("***************************************")
    ...
    create_ctl_file(stations[0],noisemodels)
    control = Control('findoffsets.ctl')
    ...
    while True:
        ...
        for station in stations:
            ...
            create_ctl_file(station,noisemodels)
            control = Control('findoffsets.ctl')
            observations = Observations()
