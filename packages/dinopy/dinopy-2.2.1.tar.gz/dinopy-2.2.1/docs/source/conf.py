...
# -*- coding: utf-8 -*-
#
# dinopy documentation build configuration file, created by
# sphinx-quickstart on Wed Sep 10 15:33:08 2014.
#
...
html_theme_path = [sphinx_rtd_theme.get_html_theme_path()] # [sphinx_bootstrap_theme.get_html_theme_path()[0]]
...
latex_documents = [
  ('index', 'dinopy.tex', 'dinopy Documentation',
   'Henning Timm, Till Hartmann', 'manual'),
]
