...
the command will prompt for a password
    ...
    def dblink(
        ...
        Args:
            ...
            password (str): the user password. If not specified, \
the command will prompt for a password. If the password contains a special character, \
make sure you escape it properly: `--password '"double#escape"'
        """
