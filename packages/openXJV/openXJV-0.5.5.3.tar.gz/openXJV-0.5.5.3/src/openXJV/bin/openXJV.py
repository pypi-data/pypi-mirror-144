...
class UI(QMainWindow):
    def __init__(self, file=None, ziplist=None, app=None):
        ...
        self.menuDatei.setFont(self.appFont)
        self.menuOptionen.setFont(self.appFont)
        self.menuAnsicht.setFont(self.appFont)
        self.menuUeber.setFont(self.appFont)
        self.menuPDF_Viewer.setFont(self.appFont)
        self.menuSpalten_ein_ausblenden.setFont(self.appFont)
        ...
        self.resize(int(screen_resolution.width()/.5),int(screen_resolution.height()/2))
