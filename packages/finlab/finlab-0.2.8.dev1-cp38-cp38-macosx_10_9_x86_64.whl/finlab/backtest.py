...
def sim(position: Union[pd.DataFrame, pd.Series], resample=None, trade_at_price='close',
    ...
    r = report.Report(
        creturn=creturn, position=position, fee_ratio=fee_ratio, tax_ratio=tax_ratio, trade_at=trade_at_price, next_trading_date=next_trading_date, market_info=market)
