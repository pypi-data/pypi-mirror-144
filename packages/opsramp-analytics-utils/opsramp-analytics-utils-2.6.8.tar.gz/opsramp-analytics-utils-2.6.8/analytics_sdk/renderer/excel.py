...
class ExcelRenderer:
    ...
    def __init__(self, analysis_run, tenantId, integrationId, excel_data, report_gen_start_time, report_gen_completed_time):
        ...
        if time_diff > API_TIME_STACKS:
            logging.info('Get excel summary response took %d (greater than %d) seconds', time_diff, API_TIME_STACKS)
    ...
    def generate_summary(self, res, tenantId, report_gen_start_time, report_gen_completed_time):
        ...
        cell = ws['C5']
        cell.value = res.json()['tenantName']
        cell.font = Font(color="000000")
        cell.fill = PatternFill("solid", fgColor="eeeeee")
        ...
        cell = ws['C11']
        start_date = res.json()['startTime']
        end_date = res.json()['endTime']
