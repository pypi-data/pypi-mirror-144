...
2. Installing the pace Package

A. Change to the directory that contains the file setup.py and the subdirectory pace. If 
...
3. Using the pace Package

The pace package is on your Python path. To import it into a Python script or session, 
execute:
