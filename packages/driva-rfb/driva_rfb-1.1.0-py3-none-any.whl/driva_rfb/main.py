...
def combine():
    """
    Use esse comando para processar o diretório compactado gerando o diretório extraído
    """
    ...
    subprocess.check_output("wc -l *.ESTABELE", shell=True, cwd="extracted")
    subprocess.check_output("wc -l ESTABELE.csv", shell=True, cwd="extracted")

    subprocess.check_output("wc -l *EMPRECSV", shell=True, cwd="extracted")
    subprocess.check_output("wc -l EMPRERFB.csv", shell=True, cwd="extracted")

    subprocess.check_output("wc -l *SOCIOCSV", shell=True, cwd="extracted")
    subprocess.check_output("wc -l SOCIORFB.csv", shell=True, cwd="extracted")
