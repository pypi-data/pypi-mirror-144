...
class SoftwareKG:
    def __init__(self, graph_path, trie_path=None):
        ...
        self.re_weight = {}
        with open(Path(DATA_DIR) / 'relation_weigth_10', 'r', encoding='utf-8') as f:
            for line in f:
    ...
    def cul_in_related_node(self, concept):
        ...
        for in_concept in in_re:
            ...
            # 计算关系得分
                re_score = self.constant.relation_score[in_concept[1]] * 0.6 + float(self.re_weight[in_concept[1]]) * 0.4
            # 计算结点得分
            pagerank_score = in_node['properties']['pagerank_score']
            p_score = math.log10(pagerank_score * 10000000) / math.log10(10000000.000021683) #10000000.000169972(V3.1.46)  (3.0.-10000000.000014795)
        ...
        sorted(nodes.items(), key=lambda d: d[0], reverse=True)
        return nodes
