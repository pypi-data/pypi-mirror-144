...
var validation_1 = __webpack_require__(/*! ./validation */ "../../node_modules/@elyra/pipeline-services/dist/validation/index.js");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validate = exports.getNodeProblems = exports.getLinkProblems = void 0;
...
function getNodeProblems(pipeline, nodeDefinitions) {
    ...
    var _loop_2 = function (n, node) {
        ...
        try {
            for (var _b = (e_3 = void 0, __values((_c = (_b = nodeDef.app_data.properties) === null || _b === void 0 ? void 0 : _b.uihints.parameter_info) !== null && _c !== void 0 ? _c : [])), _c = _b.next(); !_c.done; _c = _b.next()) {
                var prop = _c.value;
                ...
                var value = utils_1.getValue(node.app_data, prop.parameter_ref);
                if (((_d = prop.data) === null || _d === void 0 ? void 0 : _d.required) && !value) {
                    problems.push({
    ...
    try {
        for (var _e = __values(nodes.entries()), _f = _e.next(); !_f.done; _f = _e.next()) {
            var _g = __read(_f.value, 2), n = _g[0], node = _g[1];
            _loop_2(n, node);
        }
    }
    catch (e_2_1) { e_2 = { error: e_2_1 }; }
...
function validate(pipeline, nodeDefinitions) {
    var e_4, _a;
...
function getValue(app_data, key) {
    var _a;
    if (key.startsWith("elyra_")) {
        var stripped = key.replace(/^elyra_/, "");
        return (_a = app_data.component_parameters) === null || _a === void 0 ? void 0 : _a[stripped];
    }
    return app_data[key];
}
...
//# sourceMappingURL=vendors-node_modules_elyra_pipeline-services_dist_index_js.2074929cf706236c791f.js.map