...
def eam_to_eam_alloy(eam, symbol, numr=None, cutoffr=None, deltar=None,
                     numrho=None, cutoffrho=None, deltarho=None, header=None):
    """
    Converts one or more parameter files in the eam format to the eam/alloy format.
    ...
    numr : int, optional
        The number of r tabulation points to use in the alloy file.  If given, then
        cutoffr and/or deltar must be given.  If not given, will use the r tabulation
        points from the eam parameter file with the largest r cutoff.
    cutoffr : float, optional
        The r cutoff value to use in the alloy file.  Will be used in tabulating r
        values if numr is given and deltar is not.
    deltar : float, optional
        The r step size to use for the r tabulation points in the alloy file. If given,
        numr must also be given.
    numrho : int, optional
        The number of rho tabulation points to use in the alloy file. If given, then
        cutoffrho and/or deltarho must be given.  If not given, will use the rho tabulation
        points from the eam parameter file with the largest rho cutoff.
    cutoffrho : float, optional
        The rho cutoff value to use in the alloy file.  Will be used in tabulating rho
        values if numrho is given and deltarho is not.
    deltarho : float, optional
        The rho step size to use for the r tabulation points in the alloy file. If given,
        numrho must also be given.
    """
