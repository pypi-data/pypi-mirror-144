...
class ApolloClient(object):
    ...
    def __init__(self, config_url, app_id, cluster='default', secret='', start_hot_update=True, change_listener=None, log_file_path=None):
        self.logger = get_logger(name=__name__, log_path=log_file_path, log_level=logging.ERROR)
    ...
    def get_value(self, key, default_val=None, namespace='application'):
        try:
            ...
            no_key = self.no_key_cache_key(namespace, key)
    ...
    def _long_poll(self):
        ...
        try:
            ...
            param_str = self.url_encode_wrapper(params)
            url = url + '?' + param_str
