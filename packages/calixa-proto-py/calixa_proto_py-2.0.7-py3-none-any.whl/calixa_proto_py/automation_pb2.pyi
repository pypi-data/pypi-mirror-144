...
class ActionResult(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"action_Result",b"action_Result",u"error",b"error",u"httpResponses",b"httpResponses",u"sent",b"sent",u"suppressed",b"suppressed"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"action_Result",b"action_Result",u"error",b"error",u"httpResponses",b"httpResponses",u"sent",b"sent",u"suppressed",b"suppressed"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"action_Result",b"action_Result"]) -> typing_extensions___Literal["sent","httpResponses","error","suppressed"]: ...
...
class HttpResponses(google___protobuf___message___Message):
    ...
    @property
    def httpResponse(self) -> typing___MutableMapping[typing___Text, action_pb2___ThirdPartyActionInvocationResponse]: ...
