...
class EntityServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTrendSearches = channel.unary_stream(
                '/calixa.domain.entity.EntityService/GetTrendSearches',
                request_serializer=entity__pb2.GetTrendSearchesRequest.SerializeToString,
                response_deserializer=entity__pb2.Entity.FromString,
                )
        ...
        self.GetDatawarehouseSyncs = channel.unary_stream(
                '/calixa.domain.entity.EntityService/GetDatawarehouseSyncs',
                request_serializer=entity__pb2.GetDatawarehouseSyncsRequest.SerializeToString,
                response_deserializer=entity__pb2.Entity.FromString,
                )
...
class EntityServiceServicer(object):
    ...
    def GetTrendSearches(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def GetDatawarehouseSyncs(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EntityServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTrendSearches': grpc.unary_stream_rpc_method_handler(
                    servicer.GetTrendSearches,
                    request_deserializer=entity__pb2.GetTrendSearchesRequest.FromString,
                    response_serializer=entity__pb2.Entity.SerializeToString,
            ),
            ...
            'GetDatawarehouseSyncs': grpc.unary_stream_rpc_method_handler(
                    servicer.GetDatawarehouseSyncs,
                    request_deserializer=entity__pb2.GetDatawarehouseSyncsRequest.FromString,
                    response_serializer=entity__pb2.Entity.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class EntityService(object):
    ...
    def GetTrendSearches(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.entity.EntityService/GetTrendSearches',
            entity__pb2.GetTrendSearchesRequest.SerializeToString,
            entity__pb2.Entity.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def GetDatawarehouseSyncs(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.entity.EntityService/GetDatawarehouseSyncs',
            entity__pb2.GetDatawarehouseSyncsRequest.SerializeToString,
            entity__pb2.Entity.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
