...
class Excel(object):
    ...
    def makeExcel(self,output_file_name,protection=True,sheets=None,tables=None):
        self.sheets=sheets if sheets else self.sheets
        self.tables=tables if tables else self.tables
        
        self.sheets.values=sheets if sheets is not None else self.sheets.values()
        self.tables.values=tables if tables is not None else self.tables.values()
        
        ew = ExcelWritter(self,output_file_name)
        if protection:
