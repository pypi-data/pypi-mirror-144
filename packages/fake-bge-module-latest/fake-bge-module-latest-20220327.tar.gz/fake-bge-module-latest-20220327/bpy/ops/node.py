...
def collapse_hide_unused_toggle():
    ''' Toggle collapsed nodes and hide unused sockets :file: startup/bl_operators/node.py\:255 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$255> _
...
def copy_geometry_node_group_assign():
    ''' Copy the active geometry node group and assign it to the active modifier :file: startup/bl_operators/geometry_nodes.py\:93 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/geometry_nodes.py$93> _
...
def new_geometry_node_group_assign():
    ''' Create a new geometry node group and assign it to the active modifier :file: startup/bl_operators/geometry_nodes.py\:67 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/geometry_nodes.py$67> _
...
def tree_path_parent():
    ''' Go to parent node tree :file: startup/bl_operators/node.py\:285 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$285> _
