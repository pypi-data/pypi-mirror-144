...
class TrackingIds(AvroModel):
    ...
    sfdc_lead_ids: typing.Dict[str, SfdcLeadId] = dc.field(default_factory=lambda: {"a_lead_id": SfdcLeadId().asdict()})
    sfdc_contact_ids: typing.Dict[str, SfdcContactId] = dc.field(
        default_factory=lambda: {"a_contact_id": SfdcContactId().asdict()}
    )
