...
class OHLCV(pd.DataFrame):
    ...
    def from_exchange(
        ...
        Arguments:
            ...
            refresh_cache: Force OHLCV download to refresh saved cache.
            show_progress: Boolean that determines if we're goind
                to show the progress bar or not. Also determines if we print
                out any informational prints.
        ...
        if (use_cache and cache_filepath.is_file()) and not refresh_cache:
            try:
