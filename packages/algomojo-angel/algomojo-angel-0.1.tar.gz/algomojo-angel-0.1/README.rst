...
Description: 
	...
	Sample order_list: 
		[{"user_apikey":"af672a5019523acd27bc4d48ca12cb73","api_secret":"c730c830595ebad80df35ae88e433ced",
		"ticker":"INFY-EQ","exchange":"NSE","action":"B","qty":"1","price":"500","ordertype":"MKT",
		"product":"C","trigprc":"0","discqty":"0","stoploss":"0","squareoff":"0","trailstoploss":"0","token":"1245"},
		{"user_apikey":"af672a6489523acd27bc4d48ca12cb73",
	...
	Sample function call:  
        ...
        ### 3. place_option_order
        		...
        		Sample :          
        		        at.place_option_order(spot="NIFTY",expiry="24FEB22",action="B",optiontype="C",
						ordertype="MKT",qty="50",strike="100")
        
        		
        ### 4. modify_order:
        
        		Funtion with mandatory parameters:  
        			     	modify_order(orderno,token,qty,price)
        		
        		Function with all parameters:
        		 	      	modify_order(orderno,exchange,ticker,ordertype,qty,prc,trigprice)
        		
        		Sample for tradejini: `		   
        				at.modify_order(orderno="1457896512",token="1234",
						        qty="70",prc="600")
