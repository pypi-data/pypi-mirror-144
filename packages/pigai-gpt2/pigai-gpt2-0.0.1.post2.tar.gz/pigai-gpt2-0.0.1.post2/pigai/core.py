...
from .exceptions import LoginTimeoutException, AuthException, InvalidParamsException
...
def runner(
    ...
    try:
        _launcher(username, password, pids, class_name, content_length, save_action_memory, check_result)
    except requests.exceptions.SSLError as err:
        logger.error("请执行 `pip install urllib3==1.25.1` ")
        raise InvalidParamsException from err
