...
class FargateToSns(
    ...
    def __init__(
        ...
        *,
        ...
        :param topic_arn_environment_variable_name: Optional Name for the SNS topic arn environment variable set for the container. Default: - None
        :param topic_name_environment_variable_name: Optional Name for the SNS topic name environment variable set for the container. Default: - None
