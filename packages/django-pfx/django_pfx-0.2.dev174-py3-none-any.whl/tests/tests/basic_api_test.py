...
class BasicAPITest(TestAssertMixin, TestCase):
    ...
    def test_minutes_duration_field(self):
        self.author1_book1.read_time = timedelta(hours=2, minutes=30)
        self.author1_book1.save()
        response = self.client.get(f'/api/books/{self.author1_book1.pk}')
        self.assertRC(response, 200)
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time=None))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time', None)

        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time=2.5))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 150)
        self.assertJE(response, 'read_time.clock_format', "2:30")
        self.assertJE(response, 'read_time.human_format', "2h\xa030m")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="2.5h"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 150)
        self.assertJE(response, 'read_time.clock_format', "2:30")
        self.assertJE(response, 'read_time.human_format', "2h\xa030m")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="2h 30m"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 150)
        self.assertJE(response, 'read_time.clock_format', "2:30")
        self.assertJE(response, 'read_time.human_format', "2h\xa030m")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="2:30"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 150)
        self.assertJE(response, 'read_time.clock_format', "2:30")
        self.assertJE(response, 'read_time.human_format', "2h\xa030m")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time=2))
        self.assertRC(response, 200)
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="2h"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 120)
        self.assertJE(response, 'read_time.clock_format', "2:00")
        self.assertJE(response, 'read_time.human_format', "2h")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="2:00"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 120)
        self.assertJE(response, 'read_time.clock_format', "2:00")
        self.assertJE(response, 'read_time.human_format', "2h")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time=0.5))
        self.assertRC(response, 200)
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="0.5h"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 30)
        self.assertJE(response, 'read_time.clock_format', "0:30")
        self.assertJE(response, 'read_time.human_format', "30m")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="30m"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 30)
        self.assertJE(response, 'read_time.clock_format', "0:30")
        self.assertJE(response, 'read_time.human_format', "30m")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time=":30"))
        self.assertRC(response, 200)
        self.assertJE(response, 'read_time.minutes', 30)
        self.assertJE(response, 'read_time.clock_format', "0:30")
        self.assertJE(response, 'read_time.human_format', "30m")
        ...
        response = self.client.put(
            f'/api/books/{self.author1_book1.pk}', dict(read_time="INVALID"))
        self.assertRC(response, 422)
        self.assertJE(
