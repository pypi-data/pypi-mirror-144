#not working - works in notebook but syntax error from here
#import subprocess
#subprocess.run("python -m pip install -U matplotlib", shell=True)
#placing down here in hopes pip install will finish
import matplotlib
