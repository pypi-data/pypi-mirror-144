...
def gentcst(fold: str = '*',
    ...
    for file in use_files:
        ...
        if 'truth_settings' in config:
            if 'function' in config['truth_settings']:
                truth_settings['function'] = config['truth_settings']['function']
            if 'config' in config['truth_settings']:
                truth_settings['config'] = deepcopy(config['truth_settings']['config'])
