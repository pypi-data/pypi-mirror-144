...
setuptools.setup(
    name=name,
    version=md.version,
    description="Tools for quality controlling the BioModels database",
    long_description=md.long_description,
    url="https://github.com/biosimulations/biomodels-qc",
    ...
    entry_points={
        'console_scripts': [
            'biomodels-qc = biomodels_qc.__main__:main',
        ],
    },
)
