...
class RCBImage(RCallback):
    ...
    def cbPropagateBalloons(self, firstSlice: Optional[int] = None, lastSlice: Optional[int] = None,
        ...
        if continue_flag:
            ...
            self.pjs.undo_stack.push({'changetype': undo_modes.MULTI, 'frame': (start - 1, end), 'index': (True, True),
    ...
    def inflateBalloon(self, parameters: dict, theslices: numpy.ndarray, paint: bool = True) -> bool:
        ...
        for i in range(num_slices):
            ...
            init_poly = self.pjs.removePolyline(x, y, theslices[i], paint=paint, pushundo=True)
            ...
            self.pjs.addPolyline(apoly, theslices[i], paint=paint, pushundo=True)
        return True
