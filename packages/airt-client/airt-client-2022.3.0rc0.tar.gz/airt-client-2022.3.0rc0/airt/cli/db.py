...
def from_mysql(
    ...
    password: Optional[str] = typer.Option(
        ...
        "--password",
        "-p",
        help="If not passed, then the value set in the environment variable"
...
def from_csv(
    ...
    sort_by: str = typer.Option(
        ...,
        help="The column to use for sorting the data.",
    ),
    ...
    kwargs_json: Optional[str] = typer.Option(
        ...
        "Example keys: usecols, parse_dates, skiprows, etc.,",
    ),
    quiet: bool = typer.Option(
        False,
        "--quiet",
