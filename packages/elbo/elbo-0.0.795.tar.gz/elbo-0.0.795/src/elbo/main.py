...
def get_upload_url(file_size, destination_file_path="", is_training_task=True):
    """
    ...
    params = {
        'file_upload_request': is_file_upload_request,
        'large_file_upload': is_large_file_upload,
