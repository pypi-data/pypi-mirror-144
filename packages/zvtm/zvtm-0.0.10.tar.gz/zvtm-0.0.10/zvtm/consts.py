...
# zvt home dir
ZVT_HOME = os.environ.get('ZVTM_HOME')
if not ZVT_HOME:
    ZVT_HOME = os.path.abspath(os.path.join(Path.home(), 'zvtm-home'))

# data for testing
ZVT_TEST_HOME = os.path.abspath(os.path.join(Path.home(), 'zvtm-test-home'))
