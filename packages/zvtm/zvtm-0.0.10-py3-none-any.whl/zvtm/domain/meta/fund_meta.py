...
from zvtm.contract.register import register_entity, register_schema
from zvtm.utils import now_pd_timestamp
...
class Fund(FundMetaBase, Portfolio):
    ...
    def get_stocks(cls, code=None, codes=None, ids=None, timestamp=now_pd_timestamp(), provider=None):
        from zvtm.api.portfolio import get_fund_stocks
