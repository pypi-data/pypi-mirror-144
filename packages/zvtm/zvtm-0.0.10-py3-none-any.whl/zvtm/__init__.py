...
from zvtm.consts import DATA_SAMPLE_ZIP_PATH, ZVT_TEST_HOME, ZVT_HOME, ZVT_TEST_DATA_PATH, ZVT_TEST_ZIP_DATA_PATH
...
def init_log(file_name='zvtm.log', log_dir=None, simple_formatter=True):
    if not log_dir:
...
if os.getenv('TESTING_ZVT'):
    ...
    if not same:
        ...
        from zvtm.utils.zip_utils import unzip
