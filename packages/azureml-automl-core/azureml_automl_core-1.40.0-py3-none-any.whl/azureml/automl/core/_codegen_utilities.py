...
from typing import Any, cast, Callable, Dict, Iterable, Iterator, List, Optional, Tuple, Type
...
ALTERNATE_MAPPINGS = {
    ...
    "azureml.automl.runtime.shared.forecasting_models": [
        "azureml.training.tabular.models.forecasting_models"
    ],
