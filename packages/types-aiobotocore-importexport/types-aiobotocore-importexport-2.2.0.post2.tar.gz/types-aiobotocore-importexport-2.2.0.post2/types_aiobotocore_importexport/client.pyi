...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/)
...
class ImportExportClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#exceptions)
        """
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#can_paginate)
        """
    async def cancel_job(self, *, JobId: str, APIVersion: str = ...) -> CancelJobOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#cancel_job)
        """
    async def create_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#create_job)
        """
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#generate_presigned_url)
        """
    async def get_shipping_label(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#get_shipping_label)
        """
    async def get_status(self, *, JobId: str, APIVersion: str = ...) -> GetStatusOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#get_status)
        """
    async def list_jobs(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#list_jobs)
        """
    async def update_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#update_job)
        """
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client/#get_paginator)
        """
