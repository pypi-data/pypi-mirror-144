...
#                        makezeros = True
                ...
                if okay:
                    if param == "wind":
                        ...
                        u   = ds["u-component_of_wind_height_above_ground"][0,0,i1:i2,j1:j2].values
                        v   = ds["v-component_of_wind_height_above_ground"][0,0,i1:i2,j1:j2].values
        ...
        for ind, dataset in enumerate(datasets):
            ...
            if dataset.quantity == "wind":
                ...
                if not np.any(np.isnan(val)):
                    ...
                    print("NaNs found in " + dataset.quantity + ". Skipping this time step.")
