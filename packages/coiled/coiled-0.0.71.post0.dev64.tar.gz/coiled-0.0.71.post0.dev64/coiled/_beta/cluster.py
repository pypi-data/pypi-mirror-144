    ...
    def __init__(
        ...
        *,
        ...
        if self.worker_cpu or self.worker_memory:
            ...
            validate_vm_typing(worker_vm_types)
        ...
        if self.scheduler_cpu or self.scheduler_memory:
            ...
            validate_vm_typing(scheduler_vm_types)
            ...
            while True:
                ...
                if n_workers_ready >= num_workers_to_wait_for:
                    if n_workers_ready == self._start_n_workers:
                        ...
                        final_update = (
                            f"{n_workers_ready} workers ready. "
                            "Your cluster can be used while we work on the rest.\n"
                            "\n(To adjust this behavior, use the `wait_for_workers` arg.)"
                        )
