...
def publish_result(loss_metric, loss_value, params, tags):
    ...
    myelin.metric.post_hpo_result(config_id, config, budget, loss_metric, loss_value, params, tags, info_map)
