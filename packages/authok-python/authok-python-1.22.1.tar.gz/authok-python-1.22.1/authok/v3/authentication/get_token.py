...
class GetToken(AuthenticationBase):
    ...
    def login(self, client_id, client_secret, username, password, scope, realm,
              audience, grant_type='http://authok.cn/oauth/grant-type/password-realm'):
        ...
        (browser). This information is later on sent to the client and AuthOK.
        ...
        Args:
            ...
            use http://authok.cn/oauth/grant-type/password-realm
    ...
    def passwordless_login(self, client_id, client_secret, username, otp, realm, scope, audience):
        """Calls /oauth/token endpoint with http://authok.cn/oauth/grant-type/passwordless/otp grant type
