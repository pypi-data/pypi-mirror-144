...
class TestUsers(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.users.RestClient')
    def test_list(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/users', args[0])
    ...
    def test_get(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/users/an-id', args[0])
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/users/an-id'
        )
    ...
    def test_list_organizations(self, mock_rc):
        ...
        args, kwargs = mock_instance.get.call_args
        self.assertEqual('https://domain/api/v1/users/an-id/organizations', args[0])
        self.assertEqual(kwargs['params'], {
            'per_page': 25,
            'page': 0,
            'include_totals': 'true'
    ...
    def test_list_roles(self, mock_rc):
        ...
        args, kwargs = mock_instance.get.call_args
        self.assertEqual('https://domain/api/v1/users/an-id/roles', args[0])
        self.assertEqual(kwargs['params'], {
            'per_page': 25,
            'page': 0,
            'include_totals': 'true'
    ...
    def test_remove_roles(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/users/an-id/roles',
                         args[0])
    ...
    def test_list_permissions(self, mock_rc):
        ...
        args, kwargs = mock_instance.get.call_args
        self.assertEqual('https://domain/api/v1/users/an-id/permissions', args[0])
        self.assertEqual(kwargs['params'], {
            'per_page': 25,
            'page': 0,
            'include_totals': 'true'
    ...
    def test_remove_permissions(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/users/an-id/permissions',
                         args[0])
    ...
    def test_delete_multifactor(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/users/an-id/multifactor/provider'
        )
    ...
    def test_delete_authenticators(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/users/an-id/authenticators'
        )
    ...
    def test_unlink_user_account(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/users/an-id/identities/provider/user-id'
        )
    ...
    def test_link_user_account(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/users/user-id/identities',
                         args[0])
        self.assertEqual(kwargs['data'], {'a': 'b', 'c': 'd'})
    ...
    def test_regenerate_recovery_code(self, mock_rc):
        ...
        mock_instance.post.assert_called_with(
            'https://domain/api/v1/users/user-id/recovery-code-regeneration'
        )
    ...
    def test_get_guardian_enrollments(self, mock_rc):
        ...
        mock_instance.get.assert_called_with(
            'https://domain/api/v1/users/user-id/enrollments'
        )
    ...
    def test_get_log_events(self, mock_rc):
        ...
        args, kwargs = mock_instance.get.call_args
        self.assertEqual('https://domain/api/v1/users/used_id/logs', args[0])
    ...
    def test_invalidate_remembered_browsers(self, mock_rc):
        ...
        args, kwargs = mock_instance.post.call_args
        self.assertEqual('https://domain/api/v1/users/user-id/multifactor/actions/invalidate-remember-browser', args[0])
