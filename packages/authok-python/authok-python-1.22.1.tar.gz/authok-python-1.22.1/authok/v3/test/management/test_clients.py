...
class TestClients(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.clients.RestClient')
    def test_all(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/clients', args[0])
    ...
    def test_get(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/clients/this-id', args[0])
        self.assertEqual(kwargs['params'], {'fields': None,
                                            'include_fields': 'true'})
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/clients/this-id'
        )
    ...
    def test_rotate_secret(self, mock_rc):
        ...
        mock_instance.post.assert_called_with(
            'https://domain/api/v1/clients/this-id/rotate-secret', data={'id': 'this-id'}
        )
