...
class TestRules(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.rules.RestClient')
    def test_all(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/rules', args[0])
    ...
    def test_get(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/rules/an-id', args[0])
        self.assertEqual(kwargs['params'], {'fields': None,
                                            'include_fields': 'true'})
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/rules/an-id'
        )
