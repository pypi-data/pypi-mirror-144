...
class TestPrompts(unittest.TestCase):
    ...
    @mock.patch("authok.v3.management.prompts.RestClient")
    def test_get(self, mock_rc):
        ...
        self.assertEqual("https://domain/api/v1/prompts", args[0])
    ...
    def test_get_custom_text(self, mock_rc):
        ...
        self.assertEqual("https://domain/api/v1/prompts/some-prompt/custom-text/some-language", args[0])
