...
class TestLogStreams(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.log_streams.RestClient')
    def test_list(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/log-streams', args[0])
    ...
    def test_get(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/log-streams/an-id', args[0])
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/log-streams/an-id'
        )
