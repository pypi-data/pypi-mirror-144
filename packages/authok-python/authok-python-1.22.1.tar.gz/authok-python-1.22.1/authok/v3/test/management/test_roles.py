...
class TestRoles(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.roles.RestClient')
    def test_list(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/roles', args[0])
    ...
    def test_get(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/roles/an-id', args[0])
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/roles/an-id'
        )
    ...
    def test_list_users(self, mock_rc):
        ...
        args, kwargs = mock_instance.get.call_args
        self.assertEqual('https://domain/api/v1/roles/an-id/users', args[0])
        self.assertEqual(kwargs['params'], {
            'per_page': 25,
            'page': 0,
            'include_totals': 'true',
    ...
    def test_add_users(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/roles/an-id/users',
                         args[0])
    ...
    def test_list_permissions(self, mock_rc):
        ...
        args, kwargs = mock_instance.get.call_args
        self.assertEqual('https://domain/api/v1/roles/an-id/permissions', args[0])
        self.assertEqual(kwargs['params'], {
            'per_page': 25,
            'page': 0,
            'include_totals': 'true'
    ...
    def test_remove_permissions(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/roles/an-id/permissions',
                         args[0])
