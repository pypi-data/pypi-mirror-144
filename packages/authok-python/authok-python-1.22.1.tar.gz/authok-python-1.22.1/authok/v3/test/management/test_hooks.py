...
class TestRules(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.hooks.RestClient')
    def test_all(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/hooks', args[0])
    ...
    def test_get(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/hooks/an-id', args[0])
        self.assertEqual(kwargs['params'], {'fields': None})
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/hooks/an-id'
        )
    ...
    def test_add_secret(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/hooks/an-id/secrets', args[0])
        self.assertEqual(kwargs['data'], {'a': 'b', 'c': 'd'})
