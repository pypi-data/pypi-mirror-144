...
class TestBlacklists(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.blacklists.RestClient')
    def test_get(self, mock_rc):
        ...
        mock_instance.get.assert_called_with(
            'https://domain/api/v1/blacklists/tokens',
            params={'aud': 'an-id'}
        )
    ...
    def test_create(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/blacklists/tokens', args[0])
