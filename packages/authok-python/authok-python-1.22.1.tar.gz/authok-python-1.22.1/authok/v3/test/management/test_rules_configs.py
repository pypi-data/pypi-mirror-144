...
class TestRulesConfigs(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.rules_configs.RestClient')
    def test_all(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/rules-configs', args[0])
    ...
    def test_unset(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/rules-configs/an-id'
        )
    ...
    def test_set(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/rules-configs/key', args[0])
