...
class TestCustomDomains(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.custom_domains.RestClient')
    def test_get_all(self, mock_rc):
        ...
        mock_instance.get.assert_called_with(
            'https://domain/api/v1/custom-domains'
        )
    ...
    def test_create_new(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/custom-domains',args[0])
    ...
    def test_get_domain_by_id(self, mock_rc):
        ...
        mock_instance.get.assert_called_with('https://domain/api/v1/custom-domains/an-id')
    ...
    def test_verify(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/custom-domains/an-id/verify', args[0])
