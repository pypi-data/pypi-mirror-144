...
class TestDeviceCredentials(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.device_credentials.RestClient')
    def test_get(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/device-credentials', args[0])
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/device-credentials/an-id',
        )
