...
class TestActions(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.actions.RestClient')
    def test_get_actions(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/actions', args[0])
    ...
    def test_create_action(self, mock_rc):
        ...
        mock_instance.post.assert_called_with(
            'https://domain/api/v1/actions/actions',
            data={'a': 'b', 'c': 'd'}
        )
    ...
    def test_update_action(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/actions/action-id', args[0])
    ...
    def test_get_triggers(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/triggers', args[0])
        self.assertEqual(kwargs['params'], {})
    ...
    def test_get_execution(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/executions/execution-id', args[0])
        self.assertEqual(kwargs['params'], {})
    ...
    def test_get_action_versions(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/actions/action-id/versions', args[0])
    ...
    def test_get_trigger_bindings(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/triggers/trigger-id/bindings', args[0])
        self.assertEqual(kwargs['params'], {'page': None,
                                            'per_page': None})
    ...
    def test_get_action_version(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/actions/action-id/versions/version-id', args[0])
        self.assertEqual(kwargs['params'], {})
    ...
    def test_deploy_action(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/actions/action-id/deploy', args[0])
    ...
    def test_rollback_action(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/actions/actions/action-id/versions/version-id/deploy', args[0])
