...
class TestGrants(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.grants.RestClient')
    def test_get_all(self, mock_rc):
        ...
        mock_instance.get.assert_called_with(
            'https://domain/api/v1/grants', params={'user_id': 'an-id', 'client_id': 'an-id', 'audience': 'test', 'page': None, 'per_page': None, 'include_totals': 'false'}
        )
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/grants/an-id'
        )
