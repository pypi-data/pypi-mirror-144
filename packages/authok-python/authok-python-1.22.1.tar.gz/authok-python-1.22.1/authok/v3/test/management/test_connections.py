...
class TestConnection(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.connections.RestClient')
    def test_all(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/connections', args[0])
        ...
        c.all(fields=['a', 'b'], strategy='authok', include_fields=True)
    ...
    def test_get(self, mock_rc):
        ...
        args, kwargs = mock_instance.get.call_args
        self.assertEqual('https://domain/api/v1/connections/an-id', args[0])
        self.assertEqual(kwargs['params'], {'fields': None,
                                            'include_fields': 'true'})
    ...
    def test_delete(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/connections/this-id'
        )
    ...
    def test_update(self, mock_rc):
        ...
        mock_instance.patch.assert_called_with(
            'https://domain/api/v1/connections/that-id',
            data={'a': 'b', 'c': 'd'}
        )
    ...
    def test_create(self, mock_rc):
        ...
        mock_instance.post.assert_called_with(
            'https://domain/api/v1/connections',
            data={'a': 'b', 'c': 'd'}
        )
    ...
    def test_delete_user_by_email(self, mock_rc):
        ...
        mock_instance.delete.assert_called_with(
            'https://domain/api/v1/connections/123/users',
