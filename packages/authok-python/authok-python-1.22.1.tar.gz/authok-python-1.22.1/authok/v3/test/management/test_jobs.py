...
class TestJobs(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.jobs.RestClient')
    def test_get(self, mock_rc):
        ...
        mock_instance.get.assert_called_with(
            'https://domain/api/v1/jobs/an-id',
        )
    ...
    def test_get_failed_job(self, mock_rc):
        ...
        mock_instance.get.assert_called_with(
            'https://domain/api/v1/jobs/an-id/errors',
        )
    ...
    def test_export_users(self, mock_rc):
        ...
        mock_instance.post.assert_called_with(
            'https://domain/api/v1/jobs/users-exports',
    ...
    def test_import_users(self, mock_rc):
        ...
        mock_instance.file_post.assert_called_with(
            'https://domain/api/v1/jobs/users-imports',
    ...
    def test_verification_email(self, mock_rc):
        ...
        mock_instance.post.assert_called_with(
            'https://domain/api/v1/jobs/verification-email',
            data={'a': 'b', 'c': 'd'}
        )
