...
class TestAttackProtection(unittest.TestCase):
    ...
    @mock.patch('authok.v3.management.attack_protection.RestClient')
    def test_get_breached_password_detection(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/attack-protection/breached-password-detection', args[0])
    ...
    def test_update_breached_password_detection(self, mock_rc):
        ...
        mock_instance.patch.assert_called_with(
            'https://domain/api/v1/attack-protection/breached-password-detection',
            data={'a': 'b', 'c': 'd'}
        )
    ...
    def test_get_brute_force_protection(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/attack-protection/brute-force-protection', args[0])
    ...
    def test_update_brute_force_protection(self, mock_rc):
        ...
        mock_instance.patch.assert_called_with(
            'https://domain/api/v1/attack-protection/brute-force-protection',
            data={'a': 'b', 'c': 'd'}
        )
    ...
    def test_get_suspicious_ip_throttling(self, mock_rc):
        ...
        self.assertEqual('https://domain/api/v1/attack-protection/suspicious-ip-throttling', args[0])
    ...
    def test_update_suspicious_ip_throttling(self, mock_rc):
        ...
        mock_instance.patch.assert_called_with(
            'https://domain/api/v1/attack-protection/suspicious-ip-throttling',
            data={'a': 'b', 'c': 'd'}
        )
