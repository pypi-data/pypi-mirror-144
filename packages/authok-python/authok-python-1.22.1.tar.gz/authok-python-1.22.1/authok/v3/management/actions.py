...
class Actions(object):
    ...
    def _url(self, *args):
        url = '{}://{}/api/v1/actions'.format(self.protocol, self.domain)
        for p in args:
            if p is not None:
                url = '{}/{}'.format(url, p)
        return url
    ...
    def get_actions(self, trigger_id=None, action_name=None, deployed=None, installed=False, page=None, per_page=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/get_actions
        """
    ...
    def create_action(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/post_action
        """
    ...
    def update_action(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/patch_action
        """
    ...
    def get_action(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/get_action
        """
        params = {}
    ...
    def delete_action(self, id, force=False):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/delete_action
        """
        params = {
    ...
    def get_triggers(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/get_triggers
        """
        params = {}
    ...
    def get_execution(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/get_execution
        """
        params = {}
    ...
    def get_action_versions(self, id, page=None, per_page=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/get_action_versions
        """
        params = {
            'page': page,
            'per_page': per_page
    ...
    def get_trigger_bindings(self, id, page=None, per_page=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/get_bindings
        """
        params = {
            'page': page,
            'per_page': per_page
    ...
    def get_action_version(self, action_id, version_id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/get_action_version
        """
        params = {}
    ...
    def deploy_action(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/post_deploy_action
        """
    ...
    def rollback_action_version(self, action_id, version_id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/post_deploy_draft_version
        """
        params = {}
    ...
    def update_trigger_bindings(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Actions/patch_bindings
        """
