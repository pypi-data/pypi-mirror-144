...
class RulesConfigs(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/rules-configs'.format(self.protocol, self.domain)
        if id is not None:
            return url + '/' + id
        return url
    ...
    def all(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Rules_Configs/get_rules_configs
        """
    ...
    def unset(self, key):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Rules_Configs/delete_rules_configs_by_key
        """
    ...
    def set(self, key, value):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Rules_Configs/put_rules_configs_by_key
        """
