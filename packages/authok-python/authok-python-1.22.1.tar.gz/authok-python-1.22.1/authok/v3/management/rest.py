...
class RestClient(object):
    ...
    def __init__(self, jwt, telemetry=True, timeout=5.0, options=None):
        ...
        if options.telemetry:
            ...
            version = sys.modules['authok'].__version__

            authok_client = json.dumps({
                'name': 'authok-python',
                'version': version,
                'env': {
                    'python': py_version,
            ...
            self.base_headers.update({
                ...
                'AuthOK-Client': base64.b64encode(authok_client),
            })
...
class Response(object):
    ...
    def content(self):
        if self._is_error():
            ...
            raise AuthOKError(status_code=self._status_code,
