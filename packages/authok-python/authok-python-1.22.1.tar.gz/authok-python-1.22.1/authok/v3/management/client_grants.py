...
class ClientGrants(object):
    """AuthOK client grants endpoints
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/client-grants'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def all(self, audience=None, page=None, per_page=None, include_totals=False, client_id=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Client_Grants/get_client_grants
        """
    ...
    def create(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Client_Grants/post_client_grants
        """
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Client_Grants/delete_client_grants_by_id
        """
    ...
    def update(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Client_Grants/patch_client_grants_by_id
        """
