...
class Hooks(object):
    ...
    def _url(self, id=None):
        url = "{}://{}/api/v1/hooks".format(self.protocol, self.domain)
        if id is not None:
    ...
    def all(
        ...
        See: https://docs.authok.cn/api/management/v1#!/Hooks/get_hooks
        """
    ...
    def create(self, body):
        ...
        Args:
            body (dict): Attributes for the newly created hook,
                See: https://docs.authok.cn/api/v1#!/Hooks/post_hooks
        """
    ...
    def get(self, id, fields=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Hooks/get_hooks_by_id
        """
        params = {
            "fields": fields and ",".join(fields) or None,
        }
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/docs/api/management/v1#!/Hooks/delete_hooks_by_id
        """
    ...
    def update(self, id, body):
        ...
        See: https://docs.authok.cn/docs/api/v1#!/Hooks/patch_hooks_by_id
        """
    ...
    def get_secrets(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Hooks/get_secrets
        """
    ...
    def add_secrets(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Hooks/post_secrets
        """
    ...
    def delete_secrets(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Hooks/delete_secrets
        """
    ...
    def update_secrets(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Hooks/patch_secrets
        """
