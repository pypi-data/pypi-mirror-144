...
class Logs(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/logs'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def search(self, page=0, per_page=50, sort=None, q=None,
        ...
        See: https://docs.authok.cn/api/management/v1#!/Logs/get_logs
        """
        params = {
            'per_page': per_page,
            'page': page,
    ...
    def get(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Logs/get_logs_by_id
        """
