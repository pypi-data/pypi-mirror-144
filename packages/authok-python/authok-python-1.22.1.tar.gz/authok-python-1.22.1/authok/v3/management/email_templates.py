...
class EmailTemplates(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/email-templates'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def create(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Email_Templates/post_email_templates
        """
    ...
    def get(self, template_name):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Email_Templates/get_email_templates_by_templateName
        """
    ...
    def update(self, template_name, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Email_Templates/patch_email_templates_by_templateName
        """
