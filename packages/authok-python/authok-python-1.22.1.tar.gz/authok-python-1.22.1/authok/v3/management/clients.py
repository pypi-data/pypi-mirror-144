...
class Clients(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/clients'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def all(self, fields=None, include_fields=True, page=None, per_page=None, extra_params=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Clients/get_clients
        """
    ...
    def create(self, body):
        ...
        See: https://docs.authok.cn/api/v1#!/Clients/post_clients
        """
    ...
    def get(self, id, fields=None, include_fields=True):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Clients/get_clients_by_id
        """
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Clients/delete_clients_by_id
        """
    ...
    def update(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Clients/patch_clients_by_id
        """
    ...
    def rotate_secret(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Clients/post_rotate_secret
        """
