...
class AttackProtection(object):
    """AuthOK attack protection endpoints

    Args:
        domain (str): Your AuthOK domain, e.g: 'username.cn.authok.cn'

        token (str): ManageOment API v1 Token
    ...
    def _url(self, component):
        return '{}://{}/api/v1/attack-protection/{}'.format(self.protocol, self.domain, component)
    ...
    def get_breached_password_detection(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Attack_Protection/get_breached_password_detection
        """
    ...
    def update_breached_password_detection(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Attack_Protection/patch_breached_password_detection
        """
        url = self._url('breached-password-detection')
    ...
    def get_brute_force_protection(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Attack_Protection/get_brute_force_protection
        """
    ...
    def update_brute_force_protection(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Attack_Protection/patch_brute_force_protection
        """
        url = self._url('brute-force-protection')
        return self.client.patch(url, data=body)
    ...
    def get_suspicious_ip_throttling(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Attack_Protection/get_suspicious_ip_throttling
        """
    ...
    def update_suspicious_ip_throttling(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Attack_Protection/patch_suspicious_ip_throttling
        """
        url = self._url('suspicious-ip-throttling')
        return self.client.patch(url, data=body)
