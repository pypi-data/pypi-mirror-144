...
class Stats(object):
    ...
    def _url(self, action):
        return '{}://{}/api/v1/stats/{}'.format(self.protocol, self.domain, action)
    ...
    def active_users(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Stats/get_active_users
        """
    ...
    def daily_stats(self, from_date=None, to_date=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Stats/get_daily
        """
