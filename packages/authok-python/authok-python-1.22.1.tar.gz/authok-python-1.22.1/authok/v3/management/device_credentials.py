...
class DeviceCredentials(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/device-credentials'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def get(self, user_id, client_id, type, fields=None, include_fields=True, page=None, per_page=None, include_totals=False):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Device_Credentials/get_device_credentials
        """
    ...
    def create(self, body):
        ...
        See: https://docs.authok.cn/api/v1#!/Device_Credentials/post_device_credentials
        """
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Device_Credentials/delete_device_credentials_by_id
        """
