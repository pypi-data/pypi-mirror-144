...
class Connections(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/connections'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def all(self, strategy=None, fields=None, include_fields=True, page=None, per_page=None, extra_params=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Connections/get_connections
    ...
    def get(self, id, fields=None, include_fields=True):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Connections/get_connections_by_id
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Connections/delete_connections_by_id
    ...
    def update(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Connections/patch_connections_by_id
    ...
    def create(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Connections/post_connections
        """
    ...
    def delete_user_by_email(self, id, email):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Connections/delete_users_by_email
