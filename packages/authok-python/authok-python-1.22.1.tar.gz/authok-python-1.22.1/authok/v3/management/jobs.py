...
class Jobs(object):
    ...
    Args:
        domain (str): Your AuthOK domain, e.g: 'username.authok.cn'
    ...
    def _url(self, path=None):
        url = '{}://{}/api/v1/jobs'.format(self.protocol, self.domain)
        if path is not None:
    ...
    def get(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Jobs/get_jobs_by_id
        """
    ...
    def get_failed_job(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Jobs/get_errors
        """
    ...
    def export_users(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Jobs/post_users_exports
        """
    ...
    def import_users(self, connection_id, file_obj, upsert=False, send_completion_email=True, external_id=None):
        ...
        Args:
            ...
            file_obj (file): A file-like object to upload. The format for
                this file is explained in: https://docs.authok.cn/bulk-import.
            ...
            upsert (bool, optional): When set to False, pre-existing users that match on email address, user ID, or username
                ...
                https://docs.authok.cn/users/references/user-profile-structure#user-profile-attributes.
        ...
        See: https://docs.authok.cn/api/management/v1#!/Jobs/post_users_imports
        """
    ...
    def send_verification_email(self, body):
        ...
        See: https://docs.authok.cn/api/v1#!/Jobs/post_verification_email
        """
