...
class Grants(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/grants'.format(self.protocol, self.domain)
        if id is not None:
            return url + '/' + id
        return url
    ...
    def all(self, page=None, per_page=None, include_totals=False, extra_params=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Grants/get_grants
        """
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Grants/delete_grants_by_id
        """
        url = self._url('%s' % (id))
