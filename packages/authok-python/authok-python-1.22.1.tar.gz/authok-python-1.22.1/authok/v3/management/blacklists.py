...
class Blacklists(object):
    ...
    def __init__(self, domain, token, telemetry=True, timeout=5.0, protocol="https", rest_options=None):
        self.url = '{}://{}/api/v1/blacklists/tokens'.format(protocol, domain)
    ...
    def get(self, aud=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Blacklists/get_tokens
        """
    ...
    def create(self, jti, aud=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Blacklists/post_tokens
        """
        body = {
            'jti': jti,
        }
