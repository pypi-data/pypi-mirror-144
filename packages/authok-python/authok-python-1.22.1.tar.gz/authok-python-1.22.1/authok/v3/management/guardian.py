...
class Guardian(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/guardian'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def all_factors(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/get_factors
        """
    ...
    def update_factor(self, name, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/put_factors_by_name
        """
    ...
    def update_templates(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/put_templates
        """
    ...
    def get_templates(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/get_templates
        """
    ...
    def get_enrollment(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/get_enrollments_by_id
        """
    ...
    def delete_enrollment(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/delete_enrollments_by_id
        """
        url = self._url('enrollments/{}'.format(id))
    ...
    def create_enrollment_ticket(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/post_ticket
        """
    ...
    def get_factor_providers(self, factor_name, name):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/get_sns
             https://docs.authok.cn/api/management/v1#!/Guardian/get_twilio
        """
    ...
    def update_factor_providers(self, factor_name, name, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Guardian/put_twilio
        """
        url = self._url('factors/{}/providers/{}'.format(factor_name, name))
        return self.client.put(url, data=body)
