...
class Roles(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/roles'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def list(self, page=0, per_page=25, include_totals=True, name_filter=None):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Roles/get_roles
        """
        params = {
            'per_page': per_page,
            'page': page,
    ...
    def create(self, body):
        ...
        See: https://docs.authok.cn/api/v1#!/Roles/post_roles
        """
    ...
    def get(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Roles/get_roles_by_id
        """
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Roles/delete_roles_by_id
        """
    ...
    def update(self, id, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Roles/patch_roles_by_id
        """
    ...
    def list_users(self, id, page=0, per_page=25, include_totals=True, from_param=None, take=None):
        ...
        See https://docs.authok.cn/api/management/v1#!/Roles/get_role_user
        """
    ...
    def add_users(self, id, users):
        ...
        See https://docs.authok.cn/api/management/v1#!/Roles/post_role_users
        """
        url = self._url('{}/users'.format(id))
        body = {'users': users}
    ...
    def list_permissions(self, id, page=0, per_page=25, include_totals=True):
        ...
        See https://docs.authok.cn/api/management/v1#!/Roles/get_role_permission
        """
        params = {
            'per_page': per_page,
            'page': page,
    ...
    def remove_permissions(self, id, permissions):
        ...
        See https://docs.authok.cn/api/management/v1#!/Roles/delete_role_permission_assignment
        """
        url = self._url('{}/permissions'.format(id))
    ...
    def add_permissions(self, id, permissions):
        ...
        See https://docs.authok.cn/api/management/v1#!/Roles/post_role_permission_assignment
        """
        url = self._url('{}/permissions'.format(id))
        body = {'permissions': permissions}
        return self.client.post(url, data=body)
