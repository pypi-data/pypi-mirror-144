...
class CustomDomains(object):
    """AuthOK custom domains endpoints
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/custom-domains'.format(self.protocol, self.domain)
        if id is not None:
            return url + '/' + id
        return url
    ...
    def all(self):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Custom_Domains/get_custom_domains
        """
    ...
    def get(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Custom_Domains/get_custom_domains_by_id
        """
        url = self._url('%s' % (id))
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Custom_Domains/delete_custom_domains_by_id
        """
        url = self._url('%s' % (id))
    ...
    def create_new(self, body):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Custom_Domains/post_custom_domains
        """
    ...
    def verify(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Custom_Domains/post_verify
        """
