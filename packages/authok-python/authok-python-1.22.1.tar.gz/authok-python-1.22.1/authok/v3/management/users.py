...
class Users(object):
    ...
    def _url(self, id=None):
        url = '{}://{}/api/v1/users'.format(self.protocol, self.domain)
        if id is not None:
    ...
    def list(self, page=0, per_page=25, sort=None, connection=None, q=None,
        ...
        Args:
            ...
            search_engine (str, optional): The version of the search_engine to use
                ...
                See: https://docs.authok.cn/users/search.
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/get_users
        """
        params = {
            'per_page': per_page,
            'page': page,
    ...
    def create(self, body):
        ...
        See: https://docs.authok.cn/api/v1#!/Users/post_users
        """
    ...
    def get(self, id, fields=None, include_fields=True):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/get_users_by_id
        """
        params = {
            'fields': fields and ','.join(fields) or None,
            'include_fields': str(include_fields).lower()
    ...
    def delete(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/delete_users_by_id
        """
    ...
    def update(self, id, body):
        ...
        See: https://docs.authok.cn/api/v1#!/Users/patch_users_by_id
        """
    ...
    def list_organizations(self, id, page=0, per_page=25, include_totals=True):
        ...
        See https://docs.authok.cn/api/management/v1#!/Users/get_organizations
        """
        params = {
            'per_page': per_page,
            'page': page,
    ...
    def list_roles(self, id, page=0, per_page=25, include_totals=True):
        ...
        See https://docs.authok.cn/api/management/v1#!/Users/get_user_roles
        """
        params = {
            'per_page': per_page,
            'page': page,
    ...
    def remove_roles(self, id, roles):
        ...
        See https://docs.authok.cn/api/management/v1#!/Users/delete_user_roles
        """
        url = self._url('{}/roles'.format(id))
        body = {'roles': roles}
    ...
    def add_roles(self, id, roles):
        ...
        See https://docs.authok.cn/api/management/v1#!/Users/post_user_roles
        """
        url = self._url('{}/roles'.format(id))
        body = {'roles': roles}
    ...
    def list_permissions(self, id, page=0, per_page=25, include_totals=True):
        ...
        See https://docs.authok.cn/api/management/v1#!/Users/get_permissions
        """
    ...
    def remove_permissions(self, id, permissions):
        ...
        See https://docs.authok.cn/api/management/v1#!/Users/delete_permissions
        """
        url = self._url('{}/permissions'.format(id))
    ...
    def add_permissions(self, id, permissions):
        ...
        See https://docs.authok.cn/api/management/v1#!/Users/post_permissions
        """
        url = self._url('{}/permissions'.format(id))
        body = {'permissions': permissions}
        return self.client.post(url, data=body)
    ...
    def delete_multifactor(self, id, provider):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/delete_multifactor_by_provider
        """
    ...
    def delete_authenticators(self, id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/delete_authenticators
        """
    ...
    def unlink_user_account(self, id, provider, user_id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/delete_user_identity_by_user_id
        """
    ...
    def link_user_account(self, user_id, body):
        ...
        See: https://docs.authok.cn/api/v1#!/Users/post_identities
        """
    ...
    def regenerate_recovery_code(self, user_id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/post_recovery_code_regeneration
        """
    ...
    def get_guardian_enrollments(self, user_id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/get_enrollments
        """
    ...
    def get_log_events(self, user_id, page=0, per_page=50, sort=None,
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/get_logs_by_user
        """
    ...
    def invalidate_remembered_browsers(self, user_id):
        ...
        See: https://docs.authok.cn/api/management/v1#!/Users/post_invalidate_remember_browser
        """
