...
def test_classification_runner_defaults_to_ignore_data_errors(mock_get_tabular_dataset,
                                                              mock_download,
                                                              mock_train_model,
                                                              mock_master_process):
...
@patch('azureml.automl.dnn.vision.classification.runner.utils.get_tabular_dataset')
def test_od_runner_defaults_to_ignore_data_errors(mock_get_tabular_dataset, mock_read_aml_dataset, mock_download):
    dataset_id = 'test_dataset_id'
    mock_dataset = DatasetMock(dataset_id)
    mock_get_tabular_dataset.return_value = mock_dataset, mock_dataset
