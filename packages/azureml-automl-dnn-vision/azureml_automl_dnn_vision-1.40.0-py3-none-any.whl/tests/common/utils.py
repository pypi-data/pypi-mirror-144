...
def mock_prepare_model_export(run, output_dir, task_type="", inference_settings_from_training={}, model_settings={},
    ...
    mock_mlflow_model_export(output_dir, task_type, model_settings, save_as_mlflow, is_yolo)


def mock_mlflow_model_export(output_dir, task_type, model_settings, save_as_mlflow=False, is_yolo=False):
    ...
    print("Saving mlflow model at {}", remote_path)
