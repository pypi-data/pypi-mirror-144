...
class MainWindow(Qt.QMainWindow):
    ...
    def __init__(self):
        ...
        # Create Logging area
        box = Qt.QVBoxLayout()
        self.logging_text_area = ergastirio.widgets.LoggerTextArea()
        box.addWidget(self.logging_text_area)
        self.mdi.containers['logging']['container'].setLayout(box)
...
def main():
    ...
    Experiment = experiment(app,window,parent=window.mdi,config_file=config_file)
