...
def lazy_import():
    ...
    globals()['V1beta1CardRequestsUpdateUpdates'] = V1beta1CardRequestsUpdateUpdates
...
class InlineObject1(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'updates': ([V1beta1CardRequestsUpdateUpdates],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            updates ([V1beta1CardRequestsUpdateUpdates]): [optional]  # noqa: E501
        """
