...
class AvailableBarcode(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, barcode, *args, **kwargs):  # noqa: E501
        """AvailableBarcode - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, barcode, *args, **kwargs):  # noqa: E501
        """AvailableBarcode - a model defined in OpenAPI
