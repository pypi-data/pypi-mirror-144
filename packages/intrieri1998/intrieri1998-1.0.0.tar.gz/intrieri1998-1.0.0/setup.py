...
short_descr = "Data and formalisms from Intrieri et al. (1998)"
...
pkg_data = {'intrieri1998': data_files}
...
setup_kwds = dict(
    ...
    url='https://gitlab.com/b326/intrieri1998',
    license='cc_by_nc',
    zip_safe=False,
