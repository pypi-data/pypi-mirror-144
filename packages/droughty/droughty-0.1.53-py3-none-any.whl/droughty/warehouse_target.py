...
from droughty.config import droughty_profile
from droughty.config import warehouse_name


## source vars

profile_pass = droughty_profile
...
for key,value in enviroment_project.items():
    ...
    if key == 'profile':
        ...
        ## global vars 
                ...
                project_name =  droughty_profile[value]['project_name']
                schema_name =  droughty_profile[value]['schema_name']
                test_schemas = droughty_profile[value]['test_schemas']
        ...
        elif droughty_profile[value]['warehouse_name'] == 'snowflake':
            
            if value in droughty_profile:

                warehouse_name =  droughty_profile[value]['warehouse_name']
                project_name =  droughty_profile[value]['project_name']
                schema_name =  droughty_profile[value]['schema_name']
                test_schemas = droughty_profile[value]['test_schemas']
                database = droughty_profile[value]['database']
                ...
                *
                ...
                select * from unioned
                """.format(database,test_schemas[0],test_schemas[1],test_schemas[2])
...
for key,value in enviroment_project.items():
    ...
    if key == 'profile':
        ...
        if droughty_profile[value]['warehouse_name'] == 'big_query':
