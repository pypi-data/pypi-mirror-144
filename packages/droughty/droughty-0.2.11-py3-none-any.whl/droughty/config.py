    ...
    if key == 'profile':
        ...
        if value in lookml_config:
            ...
            if path_source == 'local_vars':
                ...
                warehouse_name =  os.environ.get("DBT_GOOGLE_WAREHOUSE_NAME_DEV")
                schema_name = os.environ.get('DBT_GOOGLE_BIGQUERY_DATASET_DEV')
                test_schemas = os.environ.get('DBT_GOOGLE_TEST_SCHEMAS_DEV')
