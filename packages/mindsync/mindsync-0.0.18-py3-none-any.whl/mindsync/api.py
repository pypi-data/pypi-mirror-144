...
# RENTS
    ...
    async def create_code(self, file=None, private=False, **kwargs):
        ...
        @param file File to read and use content as code. If no file given default template is used.
        @param private Whether created code is marked as private.
        @return Returns the result of operation metadata.
        '''
        
        data = aiohttp.FormData()
        data.add_field('file', open(file, 'rb'), content_type='application/octet-stream')
