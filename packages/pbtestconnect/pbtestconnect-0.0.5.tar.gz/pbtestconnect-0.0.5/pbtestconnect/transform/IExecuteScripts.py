...
class ExecutionContext(BaseModel):
    ...
    """
    contentDescriptor:ScriptContent
    """
    Provides information regarding the content on the input stream.
    """
...
class IExecuteScripts:
    def execute(self, context: ExecutionContext, inputStream: BinaryIO, outputStream: BinaryIO) -> None:
        ...
        inputStream - a file like binary stream. input data into your script should be read
        from this stream.
