...
const extension = {
    ...
    activate: (app, editorServices, editorTracker, palette, settingRegistry, browserFactory, restorer, menu, launcher) => {
        ...
        if (menu) {
            ...
            menu.fileMenu.newMenu.addGroup([{ command: commandIDs.createNewPythonFile, args: { isMenu: true } }], 30);
        }
        ...
        app.commands.addCommand(commandIDs.createNewPythonFile, {
            ...
            icon: args => (args['isPalette'] ? undefined : ui_components_1.pyIcon),
            execute: args => {
...
//# sourceMappingURL=lib_index_js.1b5379ea922632c4ca23.js.map