...
const EmptyPlatformSpecificPipeline = ({ onOpenCatalog, onOpenSettings }) => {
    ...
    const customComponentsHelpTopicURL = 'https://elyra.readthedocs.io/en/v3.7.0rc0/user_guide/pipeline-components.html';
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(ui_components_1.dragDropIcon.react, { className: "drag-drop-icon", tag: "div", elementPosition: "center", height: "120px" }),
        react_1.default.createElement("h3", { className: HEADER_CLASS },
...
const pipeline_services_1 = __webpack_require__(/*! @elyra/pipeline-services */ "webpack/sharing/consume/default/@elyra/pipeline-services/@elyra/pipeline-services?df3e");
...
const pipelineProperties_1 = __importDefault(__webpack_require__(/*! ./pipelineProperties */ "./lib/pipelineProperties.js"));
const PipelineService_1 = __webpack_require__(/*! ./PipelineService */ "./lib/PipelineService.js");
...
const PipelineWrapper = ({ context, browserFactory, shell, commands, addFileToPipelineSignal, refreshPaletteSignal, settings, widgetId }) => {
                        ...
                        if (migrationError instanceof pipeline_services_1.ComponentNotFoundError) {
                            apputils_1.showDialog({
                                ...
                                body: (react_1.default.createElement("p", null,
                                    ...
                                    ' ',
                                    react_1.default.createElement("a", { href: "https://elyra.readthedocs.io/en/v3.7.0rc0/user_guide/pipeline-components.html#example-custom-components", target: "_blank", rel: "noreferrer" }, "Example Custom Components"),
                                    ' ',
                                    "and try again.")),
        ...
        if (!componentId) {
            ...
            return apputils_1.showDialog({
                ...
                body: (react_1.default.createElement("p", null,
                    ...
                    react_1.default.createElement("br", null),
                    react_1.default.createElement("br", null),
                    react_1.default.createElement("a", { href: "https://elyra.readthedocs.io/en/v3.7.0rc0/user_guide/best-practices-custom-pipeline-components.html#troubleshooting-missing-pipeline-components", target: "_blank", rel: "noreferrer" }, "Learn more..."))),
                buttons: [apputils_1.Dialog.okButton()]
            });
        }
    ...
    return (react_1.default.createElement(pipeline_editor_1.ThemeProvider, { theme: theme_1.theme },
        react_1.default.createElement(core_1.Snackbar, { open: alert !== '', autoHideDuration: 6000, onClose: handleClose },
            react_1.default.createElement(Alert_1.default, { severity: 'error', onClose: handleClose }, alert)),
        react_1.default.createElement(ui_components_1.Dropzone, { onDrop: handleDrop },
            react_1.default.createElement(pipeline_editor_1.PipelineEditor, { ref: ref, palette: palette, pipelineProperties: pipelineProperties_1.default, toolbar: toolbar, pipeline: pipeline, onAction: onAction, onChange: onChange, onDoubleClickNode: doubleClickToOpenProperties ? undefined : onDoubleClick, onError: onError, onFileRequested: onFileRequested, onPropertiesUpdateRequested: onPropertiesUpdateRequested, leftPalette: true }, type === undefined ? (react_1.default.createElement(EmptyPipelineContent_1.EmptyGenericPipeline, { onOpenSettings: handleOpenSettings })) : (react_1.default.createElement(EmptyPipelineContent_1.EmptyPlatformSpecificPipeline, { onOpenCatalog: handleOpenCatalog, onOpenSettings: handleOpenSettings }))))));
};
...
exports["default"] = pipelineProperties;
//# sourceMappingURL=pipelineProperties.js.map
...
//# sourceMappingURL=lib_index_js.34ca9870917ea4d6cc50.js.map