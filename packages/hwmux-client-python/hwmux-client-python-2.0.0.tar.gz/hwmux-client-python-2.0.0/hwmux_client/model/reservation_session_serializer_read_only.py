...
class ReservationSessionSerializerReadOnly(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, owner, details, t_requested, t_satisfied, t_completed, t_lease_expires, r_devices, r_device_groups, r_device_group_labels, a_devices, a_device_groups, *args, **kwargs):  # noqa: E501
        """ReservationSessionSerializerReadOnly - a model defined in OpenAPI

        Args:
            id (str):
            owner (bool, date, datetime, dict, float, int, list, str, none_type):
            details (str):
