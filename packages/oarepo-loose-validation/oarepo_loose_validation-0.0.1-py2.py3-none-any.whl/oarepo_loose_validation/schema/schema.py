...
# from invenio_records_resources.errors import validation_error_to_list_errors #todo dependency problem
...
class Schema(base.SchemaABC, metaclass=SchemaMeta):
    ...
    def _do_load(
        ...
        if not errors:
            ...
            # print(dir(data))
            # if len(data) > 0 and 'validace' in self.fields:
            #     self.fields['validace'] = {"test" : "testtt"}
