...
if __name__ == '__main__':
    cli([
        'plug','collector','cache-find-best','--include-subscribed','--fn','= Drum Sad'
        # 'plug','collector','cache-by-name','2019'
        # 'plug','collector','cache-by-id','37i9dQZF1EQncLwOalG3K7','1XgDvTWxoscSf45eKmIZlq','6mtYuOxzl58vSGnEDtZ9uB'
        # 'plug','collector','cache-by-id','37i9dQZF1DX4WYpdgoIcn6'
        # 'get','export','--help',
    ])
