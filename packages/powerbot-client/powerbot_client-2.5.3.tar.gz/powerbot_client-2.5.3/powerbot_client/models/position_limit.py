...
class PositionLimit(object):
    ...
    def max_netpos_limit(self):
        ...
        The maximum net position limit defines how much the currently traded net position (in MW) can go above zero per timeframe of a particular contract (XBID and LOCAL Contract). This number has to be positive.  # noqa: E501
    ...
    def max_netpos_limit(self, max_netpos_limit):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            raise ValueError("Invalid value for `max_netpos_limit`, must be a value greater than `0`")  # noqa: E501
