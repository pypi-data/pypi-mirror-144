...
[boto3.ChimeSDKMeetings 1.19.12](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/chime-sdk-meetings.html#ChimeSDKMeetings)
...
def check_value(value: TranscribeLanguageCodeType) -> bool:
    ...
```
