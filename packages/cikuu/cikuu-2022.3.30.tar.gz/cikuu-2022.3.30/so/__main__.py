...
class ES(object):
  ...
  "query": {
	...
	def dump(self, idxname): [print (json.dumps(doc))  for doc in helpers.scan(self.es,query={"query": {"match_all": {}}}, index=idxname)]
	...
	def load(self, infile, idxname, batch=100000): 
		''' load id-source-file into index, 2022.3.29 '''
		actions=[]
