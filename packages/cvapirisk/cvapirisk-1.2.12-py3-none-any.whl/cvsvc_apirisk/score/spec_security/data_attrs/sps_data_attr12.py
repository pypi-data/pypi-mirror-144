...
class SpecSecDataAttr12(ScoreNode):
    ...
    def __init__(self, qspec, target_obj=None, attr_wt=5):
        ...
        self.fix_template = \
            '[CVSPD012] [%s]: String parameter "pattern" is unrestricted.'
    ...
    def compute_openapiv2(self):
        ...
        for param_node in self.qspec.get_param_objs():
            ...
            if self.qspec.G.has_node(type_node):
                ...
                if type_val == 'string':
                    pattern_node = '%s -> pattern' % param_node
