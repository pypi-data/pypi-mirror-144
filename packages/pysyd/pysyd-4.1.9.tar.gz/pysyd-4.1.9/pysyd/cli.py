...
# Different parsers
    ...
    parent_display.add_argument('-v', '--verbose', 
                                dest='verbose',
    ...
    parent_load.add_argument('-v', '--verbose', 
                             dest='verbose',
                             help='Turn off verbose output',
                             default=True, 
                             action='store_false',
    ...
    parent_parallel.add_argument('-v', '--verbose', 
                                 dest='verbose',
    ...
    parent_run.add_argument('-v', '--verbose', 
                            dest='verbose',
                            help='Turn off verbose output',
                            default=True, 
                            action='store_false',
...
#                              default=os.path.abspath(os.getcwd()),
    ...
    parent_setup.add_argument('-v', '--verbose', 
                              dest='verbose',
                              help='Turn off verbose output',
                              default=True, 
                              action='store_false',
    ...
    parent_test.add_argument('-v', '--verbose', 
                             dest='verbose',
                             help='Turn off verbose output',
                             default=True, 
                             action='store_false',
