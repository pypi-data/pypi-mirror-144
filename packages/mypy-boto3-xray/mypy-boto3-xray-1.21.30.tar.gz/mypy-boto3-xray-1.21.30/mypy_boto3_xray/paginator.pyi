...
[Open documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/)
...
class BatchGetTracesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#batchgettracespaginator)
    """
...
class GetGroupsPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#getgroupspaginator)
    """
...
class GetSamplingRulesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#getsamplingrulespaginator)
    """
...
class GetSamplingStatisticSummariesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#getsamplingstatisticsummariespaginator)
    """
...
class GetServiceGraphPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#getservicegraphpaginator)
    """
...
class GetTimeSeriesServiceStatisticsPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#gettimeseriesservicestatisticspaginator)
    """
...
class GetTraceGraphPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#gettracegraphpaginator)
    """
...
class GetTraceSummariesPaginator(Boto3Paginator):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_xray/paginators/#gettracesummariespaginator)
    """
