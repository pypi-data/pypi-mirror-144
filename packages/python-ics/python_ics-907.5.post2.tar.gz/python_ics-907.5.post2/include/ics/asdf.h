...
#define GS_EX_ERR_OK_DEFAULTS_USED	(7)
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH1 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH1 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH2 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH1 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH2 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH2 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH3 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH2 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH3 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH3 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH4 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH3 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH4 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH4 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH5 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH4 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH5 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH5 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH6 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH5 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH6 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH6 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH7 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH6 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH7 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH7 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH8 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH7 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH8 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH8 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH9 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH8 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH9 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH9 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH10 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH9 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH10 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH10 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH11 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH10 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH11 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH11 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_OP_ETH12 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH11 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH12 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_OP_ETH12 + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_OP_ETH12 + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_ETHERNET + 6

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET_DAQ NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET + 1
...
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET_DAQ NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_ETHERNET_DAQ + 6

#define NEOVI_ERROR_DLL_RED_PREEMPTION_NOT_ENABLED_OP_ETH1 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET_DAQ + 1
...
#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C1 NEOVI_ERROR_DLL_RED_PREEMPTION_NOT_ENABLED_OP_ETH12 + 1
#define NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C1 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C1 + 1
#define NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C1 NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C1 + 1
#define NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C1 NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C1 + 1
#define NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C1 NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C1 + 1
#define NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C1 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C1 + 1
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C1 NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C1 + 1

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C2 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C1 + 1
#define NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C2 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C2 + 1
#define NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C2 NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C2 + 1
#define NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C2 NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C2 + 1
#define NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C2 NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C2 + 1
#define NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C2 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C2 + 1
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C2 NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C2 + 1

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C3 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C2 + 1
#define NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C3 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C3 + 1
#define NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C3 NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C3 + 1
#define NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C3 NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C3 + 1
#define NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C3 NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C3 + 1
#define NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C3 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C3 + 1
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C3 NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C3 + 1

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C4 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C3 + 1
#define NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C4 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_I2C4 + 1
#define NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C4 NEOVI_ERROR_DLL_RED_TX_MSG_FULL_I2C4 + 1
#define NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C4 NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_I2C4 + 1
#define NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C4 NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_I2C4 + 1
#define NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C4 NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_I2C4 + 1
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C4 NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_I2C4 + 1

#define NEOVI_ERROR_DLL_ETH_PCAP_TX_ERROR NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_I2C4 + 1
...
#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET2 NEOVI_ERROR_DLL_UNKNOWN_APP_ERROR + 1
#define NEOVI_ERROR_DLL_RED_TX_MSG_FULL_ETHERNET2 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET2 + 1
#define NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_ETHERNET2 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET2 + 2
#define NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_ETHERNET2 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET2 + 3
#define NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_ETHERNET2 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET2 + 4
#define NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_ETHERNET2 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET2 + 5
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET2 + 6

#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH1 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 1
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH2 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 2
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH3 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 3
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH4 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 4
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH5 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 5
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH6 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 6
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH7 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 7
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH8 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 8
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH9 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 9
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH10 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 10
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH11 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 11
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_OP_ETH12 NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 12
#define NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET2 + 13

#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH1 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 1
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH2 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 2
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH3 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 3
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH4 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 4
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH5 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 5
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH6 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 6
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH7 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 7
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH8 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 8
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH9 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 9
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH10 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 10
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH11 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 11
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_OP_ETH12 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 12
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_ETHERNET NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 13
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_ETHERNET2 NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 14
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_ETHERNET_DAQ NEOVI_ERROR_DLL_RED_TX_NOT_POSSIBLE_IN_TAP_LOW_LATENCY_ETHERNET + 15

#define NEOVI_ERROR_ETHERNET_IP_FRAGMENT_DATA_LOSS (NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_ETHERNET_DAQ + 1)

#define NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 (NEOVI_ERROR_ETHERNET_IP_FRAGMENT_DATA_LOSS + 1)
#define NEOVI_ERROR_DLL_RED_TX_MSG_FULL_ETHERNET3 (NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 + 1)
#define NEOVI_ERROR_DLL_RED_TX_REPORT_MSG_FULL_ETHERNET3 (NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 + 2)
#define NEOVI_ERROR_DLL_RED_DRIVER_OVERFLOW_ETHERNET3 (NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 + 3)
#define NEOVI_ERROR_DLL_NETWORK_NOT_ENABLED_ETHERNET3 (NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 + 4)
#define NEOVI_ERROR_DLL_RED_SETTINGS_NOT_SET_ETHERNET3 (NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 + 5)
#define NEOVI_ERROR_DLL_TX_NOT_SUPPORTED_IN_MODE_ETHERNET3 (NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 + 6)
#define NEOVI_ERROR_DLL_RED_JUMBO_FRAMES_NOT_SUPPORTED_ETHERNET3 (NEOVI_ERROR_DLL_RED_RX_MSG_FULL_ETHERNET3 + 7)
...
#define NEOOBD2_LC_PROD_ID (31)
#define RAD_MOON_DUO_PROD_ID (32)
#define NEOVI_FIRE3_PROD_ID (33)
#define NEOVI_RADJUPITER_PROD_ID (34)
#define VCAN4_IND_PROD_ID (35)
#define RAD_GIGASTAR_PROD_ID (36)
#define VIVIDCAN_PRO_PROD_ID (37)
#define NEOVI_ETHER_BADGE_PROD_ID (38)
#define RADEPSILON_PROD_ID (39)
#define RAD_A2B_PROD_ID (40)
#define SFP_MODULE_PROD_ID (41)
#define RADEPSILON_T_PROD_ID (42)
#define RADEPSILON_EXPRESS_PROD_ID (43)
#define RADPROXIMA_PROD_ID (44)
#define NEW_DEVICE_57_PROD_ID (45)
#define NEW_DEVICE_58_PROD_ID (46)
#define NEW_DEVICE_59_PROD_ID (47)
#define RAD_BMS_PROD_ID (48)
/*
 * deprecated hardware. RIP
 */
...
#define NEO_OBD2_LC_MCHIP_ID (79)
#define NEO_OBD2_LC_SCHIP_ID (80)
#define RAD_MOON_DUO_MCHIP_ID (81)
#define FIRE3_ZCHIP_ID (82)
#define FLEX_VNETZ_FCHIP_ID (83)
#define RADJUPITER_MCHIP_ID (84)
#define VCAN4_IND_MCHIP_ID (85)
#define ETHER_BADGE_MCHIP_ID (86)
#define NEOVI_RADGIGALOG3_ZYNQ_ID (87)
#define RADGIGASTAR_USBZ_ZYNQ_ID (88)
#define RADGIGASTAR_ZYNQ_ID (89)
#define RAD_4G_MCHIP_ID (90)
#define FIRE3_SCHIP_ID (91)
#define RADEPSILON_MCHIP_ID (92)
#define RAD_A2B_ZCHIP_ID (93)
#define NEO_OBD2_DEV_MCHIP_ID (94)
#define NEO_OBD2_DEV_SCHIP_ID (95)
#define NEO_OBD2_SIM_DOIP_MCHIP_ID (96)
#define SFP_MODULE_MCHIP_ID (97)
#define RADEPSILON_T_MCHIP_ID (98)
#define RADEPSILON_EXPRESS_MCHIP_ID (99)
#define RADPROXIMA_MCHIP_ID (100)
#define NEW_DEVICE_57_ZCHIP_ID (101)
#define NEW_DEVICE_58_ZCHIP_ID (102)
#define NEW_DEVICE_59_MCHIP_ID (103)
#define NEOVI_RADMOON2_Z7010_ZYNQ_ID (104)
#define NEOVI_FIRE2_CYAN_CORE_SG4_ID (105)
#define RAD_BMS_MCHIP_ID (106)
#define RMTZL_MCHIP_ID (107)
#define FIRE3_LINUX_ID (108)
...
// For below DeviceType definiton, refer MR-3372 DC comment.
enum
{
	LL_DEAD = 0,
	LL_PRODUCTION = 1,
	...
	LL_VCAN3_LIMITED = 8,
	LL_VCAN3 = 9,
	LL_VCAN3_PRODUCTION = 10, // limited number of transmits and then hardware trap
	LL_FIRE_PRODUCTION = 11, // limited number of transmits and then hardware trap, cgi enabled until power off or hardware trap
	LL_ECU_40 = 12,
	LL_IEVB = 13,
	LL_ECU_20 = 14,// limit USB communication
	LL_NEO_HDA = 15,
	LL_NEOOBD_LOGGER = 16,
	LL_ETHERNET_EVB = 17,
	LL_VALUECAN_RF = 18,
	...
	LL_VIVIDCAN_PRO = 35,
	LL_NEOECU12 = 36,
	LL_OBD2_LC = 37, // get the new license level from David Crockett
	LL_OBD2_DEV = 38,
	LL_FIRE3 = 39, // Another DeviceType name : Onyx
	LL_RADJUPITER = 40,
	LL_RADGIGASTAR = 41,
	LL_RADMOONDUO = 42,
	LL_AUTONOMOUS = 43,
	...
	LL_RED2_4 = 51,
	LL_RED2_2 = 52,
	LL_OBDSIM_ETHERNET = 53,
	LL_RADEPSILON_T = 54,
	LL_RADEPSILON_EXPRESS = 55,
	LL_RADPROXIMA = 56,
	LL_RADGALAXY2 = 57,
	LL_RADUNIVERSE = 58,
	LL_RADCCS = 59,
...
template<class T> // This way we can use icsSpyMessageLong et al.
static inline void icsSpyMessage_SetSourceId(T* m, uint16_t id)
{
	m->TimeSystem2 &= 0xFFFF0000;
	m->TimeSystem2 |= id;
}

template<class T>
static inline uint16_t icsSpyMessage_GetSourceId(const T* m)
{
	return m->TimeSystem2 & 0xFFFF;
}
