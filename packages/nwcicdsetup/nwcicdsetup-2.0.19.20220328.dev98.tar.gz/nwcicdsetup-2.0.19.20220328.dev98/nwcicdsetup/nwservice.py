...
class NWTask:
    ...
    async def should_execute_async(self) -> bool:
        ...
        return self.service.context.force or not(self.is_deployment and (self.is_feature_branch or self.service.context.fake_deploy)) and await self.is_changed_async
