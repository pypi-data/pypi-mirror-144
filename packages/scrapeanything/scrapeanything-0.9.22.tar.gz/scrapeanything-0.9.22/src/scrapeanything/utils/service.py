...
class Service:
    ...
    def wget(self, url: str, parameters: dict=None, method: Methods=Requests.Methods.GET, response_type: Requests.ResponseTypes=Requests.ResponseTypes.JSON) -> any:
        ...
        if response_type == WebScraper.Types.JSON:
            return response.json()
        elif response_type == WebScraper.Types.STRING:
