...
from resourceComponents import load_balancer, secrets_manager
...
class ElasticContainerService(ComponentResource):
    ...
    def __init__(self, name: str, props: None, vpc_props: None, dns_zone: None, opts:  ResourceOptions = None):
        """
