...
class Clock:
    ...
    def __rich__(self) -> Text:
        return Text(f"{datetime.now().ctime()}\ndockerich-{__version__}", style="bold magenta", justify="center")
...
has_dev_containers =  len([True for c in containers if c.name.startswith("dev_")])>0
if has_dev_containers:
    ...
    layout["stats"].update(DockerColumns(client, is_dev=False))
