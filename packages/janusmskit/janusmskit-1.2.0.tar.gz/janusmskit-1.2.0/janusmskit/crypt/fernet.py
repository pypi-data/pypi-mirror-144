...
from janusmskit.constants import CRYPT_FILE_KEY_ENVIRONMENT, CRYPT_FILE_KEY_ENVIRONMENT_LEGACY, DEFAULT_KEY_FILENAME
from janusmskit.crypt.driver import CryptAbstract
from janusmskit.exceptions import FileDoesNotExistException
from janusmskit.utils.files import LoadFile
    ...
    def read_key(self):
        ...
        if not key:
            ...
            raise FileDoesNotExistException(
                ...
                "or run `janusmskit crypt create-key` command".format(self._loader.path, crypt_file_key_env)
            )
        return key
