...
async def customize():
    ...
    try:
        ...
        await ultroid_bot.send_message(
            "botfather",
            f"✨ PowerFul Fussion Assistant Bot ✨\n✨ Master ~ {sir} ✨\n\n✨ Powered By ~ @DarkFussion ✨",
        )
        await asyncio.sleep(2)
        await ultroid_bot.send_message(
...
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
    ...
    try:
        ...
        await ultroid_bot(JoinChannelRequest("@DarkFussion"))
    except ChannelsTooMuchError:
        LOGS.info("Join @DarkFussio  to know about new Updates...")
