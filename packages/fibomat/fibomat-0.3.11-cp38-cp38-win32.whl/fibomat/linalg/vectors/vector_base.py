...
class VectorBase(Sequence[T], abc.ABC):
    ...
    def rotated(self: SelfT, theta: float, origin: Optional[Iterable[T]] = None) -> SelfT:
        ...
        if origin is not None:
            ...
            rotated_vec[0] = (self._vector[0] - origin_array[0]) * cos - (self._vector[1] - origin_array[1]) * sin
            rotated_vec[1] = (self._vector[1] - origin_array[1]) * cos + (self._vector[0] - origin_array[0]) * sin
            rotated_vec += origin_array
        else:
