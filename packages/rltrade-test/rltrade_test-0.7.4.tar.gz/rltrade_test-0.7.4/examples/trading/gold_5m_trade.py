    ...
    try:
        ...
        while current_time < end_time and current_time > start_time:
            ...
            for i,indicator in enumerate(all_indicators):
                ...
                temp = await agent.get_day_trade_actions(current_time,duration,trade_period)
            ...
            actions = await agent.get_day_trade_actions(df_actions,current_time,duration,trade_period)
