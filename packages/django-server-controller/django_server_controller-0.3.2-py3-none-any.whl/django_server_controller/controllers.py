...
class ControllerBase(object):
    ...
    def get_default_config_file(self, config_file_name):
        ...
        return fsutils.first_exists_file(
            "{project_base}/etc/{config_file_name}".format(config_file_name=config_file_name, project_base=self.project_base),
            "./etc/{config_file_name}".format(config_file_name=config_file_name),
            "~/etc/{config_file_name}".format(config_file_name=config_file_name),
            "{application_base}/{config_file_name}".format(config_file_name=config_file_name, application_base=application_base),
    ...
    def __init__(self, project_name=None, project_base=None, config_file=None, web_root=None, logs_root=None, pidfile=None, server_bin=None, **kwargs):
        ...
        self.project_base = os.path.abspath(project_base or self.get_default_project_base())
