...
class SubAPI(object):
    ...
    async def fetch_text(self, url, params=None, timeout=DEFAULT_TIMEOUT):
        if params is None:
            params = {}
    ...
    async def fetch_raw(self, url, params=None, timeout=DEFAULT_TIMEOUT):
        if params is None:
            params = {}
        async with self.driver.session.post(url, params=params) as response:
    ...
    async def fetch_json(self, url, params=None, timeout=DEFAULT_TIMEOUT):
        if params is None:
            params = {}
