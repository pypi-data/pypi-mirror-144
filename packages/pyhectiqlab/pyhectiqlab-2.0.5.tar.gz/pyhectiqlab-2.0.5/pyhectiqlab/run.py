    ...
    def _setup_run(self):
        try:
            ...
            if self.run_view.get('slug', None) is None:
                print("An error occured while creating the run. Verify the project is correctly spelled and make sure you have access to the project. Switching to read only mode with empty run.")
