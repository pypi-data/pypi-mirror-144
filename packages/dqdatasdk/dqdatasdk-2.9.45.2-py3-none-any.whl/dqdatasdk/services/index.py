...
from dqdatasdk.decorators import export_as_api, compatible_with_parm
...
from dqdatasdk.utils import int8_to_datetime
from dqdatasdk.services.calendar import get_trading_dates_in_type
...
def index_components(order_book_id, date=None, start_date=None, end_date=None, market="cn"):
    ...
    if start_date:
        ...
        date0 = dates[0]
        res = {int8_to_datetime(dt): component_ids for dt, component_ids in data.items()}
