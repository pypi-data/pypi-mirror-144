...
from dqdatasdk.services.calendar import get_next_trading_date, is_trading_date, get_previous_trading_date
from dqdatasdk.services.live import get_ticks
...
def get_price(
    ...
    from dqdatasdk.services.detail.get_price_df import get_price_df, get_week_df
    if frequency != 'w':
        df = get_price_df(
