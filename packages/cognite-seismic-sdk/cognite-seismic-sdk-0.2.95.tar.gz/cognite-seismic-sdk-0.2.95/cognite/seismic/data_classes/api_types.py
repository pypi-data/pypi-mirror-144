...
class SeismicStore:
    ...
    def __repr__(self):
        return f"SeismicStore<id: {self.id}, name: {repr(self.name)}, survey_id: {repr(self.survey_id)}, ingestion_source: {self.ingestion_source}, metadata: {self.metadata}, storage_tier: {repr(self.storage_tier_name)}>"
