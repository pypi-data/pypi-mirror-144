...
def build_node_and_resolver(
    object_type: ObjectType, edge_resolver_map_strs: T.List[str], hydrate: bool
) -> str:
    ...
    for object_type in object_types:
        node_strs.append(
            build_node_and_resolver(
                ...
                hydrate=object_type.node_name in nodes_to_hydrate,
            )
        )
...
async def build_from_config(
    db_config_d: dict, include_strawberry: bool, hydrate: bool = False
) -> str:
