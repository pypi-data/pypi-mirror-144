...
def draw_dots_and_lines(coordinate_array, draw_dots=1, draw_lines=1, max_distance=1.5, line_style='-k', linewidth=1, dot_style='ro', markersize=3, show=0, save=1, filename='a', format='eps'):
    import matplotlib.pyplot as plt
