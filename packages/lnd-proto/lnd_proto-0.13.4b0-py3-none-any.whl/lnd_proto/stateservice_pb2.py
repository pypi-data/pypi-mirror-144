...
# source: lnd_proto/stateservice.proto
...
SubscribeStateRequest = _reflection.GeneratedProtocolMessageType('SubscribeStateRequest', (_message.Message,), {
  ...
  '__module__' : 'lnd_proto.stateservice_pb2'
