...
# source: lnd_proto/lightning.proto
...
SubscribeCustomMessagesRequest = _reflection.GeneratedProtocolMessageType('SubscribeCustomMessagesRequest', (_message.Message,), {
  ...
  '__module__' : 'lnd_proto.lightning_pb2'
