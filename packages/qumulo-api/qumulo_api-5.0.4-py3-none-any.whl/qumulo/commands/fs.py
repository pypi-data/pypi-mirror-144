...
class GetAtimeSettingsCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def main(conninfo: Connection, credentials: Optional[Credentials], _args: Namespace) -> None:
        print(fs.get_atime_settings(conninfo, credentials))
...
class SetAtimeSettingsCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def main(conninfo: Connection, credentials: Optional[Credentials], args: Namespace) -> None:
        ...
        print(
            fs.set_atime_settings(
                conninfo, credentials, enabled=args.enabled, granularity=args.granularity
            )
        )
