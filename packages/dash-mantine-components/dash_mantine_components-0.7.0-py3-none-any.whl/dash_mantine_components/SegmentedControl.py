...
- value (string; optional):
    ...
    @_explicitize_args
    def __init__(self, class_name=Component.UNDEFINED, color=Component.UNDEFINED, data=Component.REQUIRED, disabled=Component.UNDEFINED, fullWidth=Component.UNDEFINED, id=Component.UNDEFINED, orientation=Component.UNDEFINED, radius=Component.UNDEFINED, size=Component.UNDEFINED, style=Component.UNDEFINED, transitionDuration=Component.UNDEFINED, transitionTimingFunction=Component.UNDEFINED, value=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'class_name', 'color', 'data', 'disabled', 'fullWidth', 'orientation', 'radius', 'size', 'style', 'transitionDuration', 'transitionTimingFunction', 'value']
        self._type = 'SegmentedControl'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'class_name', 'color', 'data', 'disabled', 'fullWidth', 'orientation', 'radius', 'size', 'style', 'transitionDuration', 'transitionTimingFunction', 'value']
