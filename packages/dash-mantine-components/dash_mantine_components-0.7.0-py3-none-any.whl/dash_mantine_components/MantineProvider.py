...
- withNormalizeCSS (boolean; optional):
    Normalize CSS?."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, styles=Component.UNDEFINED, theme=Component.UNDEFINED, withNormalizeCSS=Component.UNDEFINED, withGlobalStyles=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'styles', 'theme', 'withGlobalStyles', 'withNormalizeCSS']
        self._type = 'MantineProvider'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'styles', 'theme', 'withGlobalStyles', 'withNormalizeCSS']
