...
- src (string; optional):
    Image src."""
    @_explicitize_args
    def __init__(self, children=None, radius=Component.UNDEFINED, src=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'radius', 'src']
        self._type = 'BackgroundImage'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'radius', 'src']
