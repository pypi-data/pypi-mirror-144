...
- verticalSpacing (a value equal to: "xs", "sm", "md", "lg", "xl" | number; optional):
    ...
    in px."""
    @_explicitize_args
    def __init__(self, children=None, captionSide=Component.UNDEFINED, class_name=Component.UNDEFINED, id=Component.UNDEFINED, highlightOnHover=Component.UNDEFINED, horizontalSpacing=Component.UNDEFINED, striped=Component.UNDEFINED, style=Component.UNDEFINED, verticalSpacing=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'captionSide', 'class_name', 'highlightOnHover', 'horizontalSpacing', 'striped', 'style', 'verticalSpacing']
        self._type = 'Table'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'captionSide', 'class_name', 'highlightOnHover', 'horizontalSpacing', 'striped', 'style', 'verticalSpacing']
