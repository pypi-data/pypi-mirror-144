...
- offsetIcon (boolean; default True):
    Should icon be offset with padding, applicable only when
    iconPosition is left.

- order (a value equal to: 1, 2, 3, 4, 5, 6; default 3):
