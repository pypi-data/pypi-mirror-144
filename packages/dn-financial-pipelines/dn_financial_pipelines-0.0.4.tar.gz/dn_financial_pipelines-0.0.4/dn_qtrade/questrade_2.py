...
def __main__():
    ...
    sample_date = datetime.strptime('2021-03-24', DATE_FORMAT)
    sample_date2 = datetime.strptime('2022-03-24', DATE_FORMAT)
    # sample_date = datetime.now()
    balances = tfsa.get_share_balance([sample_date, sample_date2])
