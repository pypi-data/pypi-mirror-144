...
def logLog(df, X_trasformations, X, y, target, name_model, model_regression = 'linear', medias = [], organic = [], metric = ['rsq', 'nrmse', 'mape'], return_metric = False):
    metrics_values = {}
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_all, y_log)
