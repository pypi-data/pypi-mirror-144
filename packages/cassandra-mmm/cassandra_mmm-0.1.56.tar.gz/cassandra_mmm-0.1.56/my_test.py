...
subset_columns = ['date', 'conversions', 'fb_pr_spend', 'fb_re_spend',
                  ...
                  'tiktok_learn_spend', 'microsoft_spend', 'influencer_spend', 'email_campaigns_sessions',
...
organic = ['email_campaigns_sessions',
                  's_organic', 's_referral', 's_influencer', 's_affiliate', 's_direct', 's_partner', 's_mediapartner',
           ]
context = ['tickets_count']

#prophet_vars = ['trend', 'yearly', 'monthly', 'weekly', 'daily', 'holidays']


all_features = media + organic + context
