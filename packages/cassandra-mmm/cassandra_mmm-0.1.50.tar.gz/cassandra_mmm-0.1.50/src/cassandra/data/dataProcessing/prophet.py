...
def prophet(df, name_date_column, name_target_column, window_start='', window_end='', national_holidays_abbreviation='IT', future_dataframe_periods=14, plot_prophet=True, weekly_seasonality=True, yearly_seasonality=True, daily_seasonality=True, seasonality_mode='additive'):
    ...
    prophet_m = Prophet(weekly_seasonality=weekly_seasonality, yearly_seasonality=yearly_seasonality, daily_seasonality=daily_seasonality, holidays=holidays, seasonality_mode=seasonality_mode)
