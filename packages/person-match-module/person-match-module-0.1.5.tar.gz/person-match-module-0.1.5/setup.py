...
package_name = "person-match-module"
...
setup(
    ...
    version=version,
    author="ChangSu",
    author_email="changsu.lee@icanbwell.com",
    description="person match module",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/icanbwell/person-match-module",
    packages=find_packages(),
    install_requires=["numpy>=1.21.5", "rapidfuzz>=2.0.7"],
    classifiers=[
    ...
    zip_safe=False,
    package_data={"personmatchmodule": ["py.typed"]},
)
