...
@jsii.interface(jsii_type="cdk8s-plus-22.IPodSpec")
...
class _IPodSpecProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-22.IPodSpec"
...
@jsii.interface(jsii_type="cdk8s-plus-22.IPodTemplate")
...
class _IPodTemplateProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-22.IPodTemplate"
...
class IngressBackend(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-22.IngressBackend"):
    ...
    def from_service(
        ...
        *,
        ...
        return typing.cast("IngressBackend", jsii.sinvoke(cls, "fromService", [service, options]))
...
class PodSpec(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-22.PodSpec"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-22.PodSpecProps",
    jsii_struct_bases=[],
    name_mapping={
        "containers": "containers",
...
class PodTemplate(
    PodSpec,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk8s-plus-22.PodTemplate",
):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-22.PodTemplateProps",
...
@jsii.data_type(
    jsii_type="cdk8s-plus-22.Resources",
    jsii_struct_bases=[],
    ...
    def __init__(
        ...
        *,
        ...
        props = ServiceAccountTokenSecretProps(
            service_account=service_account, metadata=metadata
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[ResourceProps],
    name_mapping={"metadata": "metadata", "service_account": "serviceAccount"},
)
class ServiceAccountTokenSecretProps(ResourceProps):
    def __init__(
        self,
        *,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
...
class SshAuthSecret(
    ...
    def __init__(
        ...
        *,
        ...
        :param metadata: Metadata that all persisted resources must have, which includes all objects users must create.
        '''
        props = SshAuthSecretProps(ssh_private_key=ssh_private_key, metadata=metadata)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[ResourceProps],
    name_mapping={"metadata": "metadata", "ssh_private_key": "sshPrivateKey"},
)
class SshAuthSecretProps(ResourceProps):
    def __init__(
        self,
        *,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
...
class TlsSecret(Secret, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-22.TlsSecret"):
    ...
    def __init__(
        ...
        *,
        ...
        :param metadata: Metadata that all persisted resources must have, which includes all objects users must create.
        '''
        props = TlsSecretProps(tls_cert=tls_cert, tls_key=tls_key, metadata=metadata)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[ResourceProps],
    name_mapping={"metadata": "metadata", "tls_cert": "tlsCert", "tls_key": "tlsKey"},
)
class TlsSecretProps(ResourceProps):
    def __init__(
        self,
        *,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
...
class Volume(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-22.Volume"):
    ...
    @jsii.member(jsii_name="fromPersistentVolume") # type: ignore[misc]
    @builtins.classmethod
    def from_persistent_volume(
        cls,
        pv: "PersistentVolume",
        *,
        name: typing.Optional[builtins.str] = None,
        ...
        return typing.cast("Volume", jsii.sinvoke(cls, "fromPersistentVolume", [pv, options]))
    ...
    def __init__(
        ...
        *,
        ...
        props = BasicAuthSecretProps(
            password=password, username=username, metadata=metadata
        )
...
class BasicAuthSecretProps(ResourceProps):
    def __init__(
        self,
        *,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
...
class DockerConfigSecret(
    ...
    def __init__(
        ...
        *,
        ...
        :param metadata: Metadata that all persisted resources must have, which includes all objects users must create.
        '''
        props = DockerConfigSecretProps(data=data, metadata=metadata)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[ResourceProps],
    name_mapping={"metadata": "metadata", "data": "data"},
)
class DockerConfigSecretProps(ResourceProps):
    def __init__(
        self,
        *,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
...
@jsii.implements(IPodTemplate)
class Job(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-22.Job"):
...
@jsii.implements(IPersistentVolume)
...
@jsii.implements(IPodSpec)
class Pod(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-22.Pod"):
