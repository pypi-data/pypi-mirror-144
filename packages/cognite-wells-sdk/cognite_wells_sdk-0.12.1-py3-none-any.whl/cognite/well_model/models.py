...
class TimeMeasurementExternalId(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True
...
class Nds(WellsBaseModel):
    ...
    hole_start: Optional[Distance] = Field(None, alias="holeStart")
    hole_end: Optional[Distance] = Field(None, alias="holeEnd")
...
class DeleteTimeMeasurementSources(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    items: List[TimeMeasurementExternalId]
