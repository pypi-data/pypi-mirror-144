...
import refinitiv.dataplatform.legacy.json_requests
from .tools import (
    is_string_type,
...
def get_timeseries(
    ...
    response = refinitiv.dataplatform.legacy.json_requests.send_json_request(
    ...
    if len(ts_status_errors) == len(ts_timeserie_data):
        ...
        raise RDPError("Error", message=ts_error_messages)
