...
class Cube(LocalCube[Hierarchies, Levels, Measures]):
    ...
    def _aggregate_providers(self) -> Sequence[PartialAggregateProvider]:
        ...
        return self._java_api.get_aggregate_providers(
            self.name,
        )

    @_aggregate_providers.setter
    def _aggregate_providers(
        self, providers: Sequence[PartialAggregateProvider]
    ) -> None:
        """Set the partial aggregate providers."""
        self._java_api.set_aggregate_providers(self.name, providers)
