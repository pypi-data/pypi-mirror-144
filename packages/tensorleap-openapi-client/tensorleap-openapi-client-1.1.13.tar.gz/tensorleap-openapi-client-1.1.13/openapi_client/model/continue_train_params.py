...
class ContinueTrainParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, version_id, model_id, training_params, *args, **kwargs):  # noqa: E501
        """ContinueTrainParams - a model defined in OpenAPI
