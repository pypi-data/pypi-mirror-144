...
```sh
pip install git+https://github.com/cochlearai/sense-api-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/cochlearai/sense-api-client.git`)
...
# Defining the host is optional and defaults to https://api.cochl.ai/sense/api/v0
# See configuration.py for a list of all supported configuration parameters.
configuration = cochl_sense_api.Configuration(
    host = "https://api.cochl.ai/sense/api/v0"
)
...
## Documentation For Models
 ...
 - [AudioMetadatas](docs/AudioMetadatas.md)
