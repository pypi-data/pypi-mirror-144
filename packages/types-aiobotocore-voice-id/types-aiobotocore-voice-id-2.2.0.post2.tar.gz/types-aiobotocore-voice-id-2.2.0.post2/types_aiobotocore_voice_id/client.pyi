...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/)
...
class VoiceIDClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#exceptions)
        """
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#can_paginate)
        """
    async def create_domain(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#create_domain)
        """
    async def delete_domain(self, *, DomainId: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#delete_domain)
        """
    async def delete_fraudster(self, *, DomainId: str, FraudsterId: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#delete_fraudster)
        """
    async def delete_speaker(self, *, DomainId: str, SpeakerId: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#delete_speaker)
        """
    async def describe_domain(self, *, DomainId: str) -> DescribeDomainResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#describe_domain)
        """
    async def describe_fraudster(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#describe_fraudster)
        """
    async def describe_fraudster_registration_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#describe_fraudster_registration_job)
        """
    async def describe_speaker(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#describe_speaker)
        """
    async def describe_speaker_enrollment_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#describe_speaker_enrollment_job)
        """
    async def evaluate_session(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#evaluate_session)
        """
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#generate_presigned_url)
        """
    async def list_domains(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#list_domains)
        """
    async def list_fraudster_registration_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#list_fraudster_registration_jobs)
        """
    async def list_speaker_enrollment_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#list_speaker_enrollment_jobs)
        """
    async def list_speakers(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#list_speakers)
        """
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#list_tags_for_resource)
        """
    async def opt_out_speaker(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#opt_out_speaker)
        """
    async def start_fraudster_registration_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#start_fraudster_registration_job)
        """
    async def start_speaker_enrollment_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#start_speaker_enrollment_job)
        """
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#tag_resource)
        """
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#untag_resource)
        """
    async def update_domain(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_voice_id/client/#update_domain)
        """
