...
directory = os.path.join(fail_dir, "_data", "fail6")
fractal = fsm.Perturbation_mandelbrot(directory)


calc_name = 'test'
_1 = 'Zoom parameters'
x = '-1.73203526660131582567857738298110186'
y = '0.0000440611190632663216692911714513321223'
dx = '4.407550870275225e-26'
xy_ratio = 1.818181 #1.0
theta_deg = 0.0
dps = 50
nx = 400
