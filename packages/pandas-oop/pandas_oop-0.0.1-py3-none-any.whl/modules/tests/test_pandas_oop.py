...
from pandas_oop.modules.custom_exceptions import MissingDecorator
from pandas_oop.pandas_oop import models


DB_CONNECTION = sqlite3.connect(':memory:')
ABS_PATH = Path(__file__).resolve().parent.parent.parent.parent
DATA_FILE = ABS_PATH / 'pandas_oop/modules/data/data.csv'
