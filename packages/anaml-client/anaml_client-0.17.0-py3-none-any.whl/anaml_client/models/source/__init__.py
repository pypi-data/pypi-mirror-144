...
class ResourcePattern:
    """Pattern to match path or table within a source.
...
class AccessRule:
    ...
    Args:
        ...
        maskingRules (typing.List[MaskingRule]): A data field.
    """
    
    resource: ResourcePattern
    principals: typing.List[PrincipalId]
    maskingRules: typing.List[MaskingRule]
    ...
    def from_json(cls, data: dict) -> AccessRule:
        ...
        try:
            ...
            return AccessRule(
                ...
                maskingRules=[MaskingRule.from_json(v) for v in data["maskingRules"]],
            )
        except jsonschema.exceptions.ValidationError as ex:
            logging.debug(
    ...
    def to_json(self) -> dict:
        ...
        return {
            ...
            "maskingRules": [v.to_json() for v in self.maskingRules]
        }
