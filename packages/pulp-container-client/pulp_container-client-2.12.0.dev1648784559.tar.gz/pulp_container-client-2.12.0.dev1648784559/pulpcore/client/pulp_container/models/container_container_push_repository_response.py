...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, retain_repo_versions=None, pulp_created=None, description=None, pulp_labels=None, pulp_href=None, latest_version_href=None, versions_href=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
