...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, name=None, retain_repo_versions=None, description=None, pulp_labels=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
