...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, retain_repo_versions=None, pulp_href=None, versions_href=None, latest_version_href=None, pulp_created=None, manifest_signing_service=None, pulp_labels=None, description=None, local_vars_configuration=None):  # noqa: E501
