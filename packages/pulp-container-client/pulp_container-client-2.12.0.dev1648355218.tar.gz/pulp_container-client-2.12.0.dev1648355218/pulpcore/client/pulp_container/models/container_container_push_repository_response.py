...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, pulp_href=None, retain_repo_versions=None, latest_version_href=None, versions_href=None, pulp_labels=None, description=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
