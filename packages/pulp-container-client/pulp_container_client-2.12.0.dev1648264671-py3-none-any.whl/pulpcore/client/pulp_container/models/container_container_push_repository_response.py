...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, manifest_signing_service=None, description=None, pulp_labels=None, pulp_href=None, name=None, versions_href=None, pulp_created=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
