...
class PeriodicBorrowing(_Borrowing):
    ...
    holiday_calendar: holidaycal.AbstractCalendar, optional(default=None)
        Payment holidays to use in adjusting payment and calculation dates. Defaults to None.
    ...
    def _set_holiday_calendar(self, calendar):
        if calendar is None:
            ...
            self._holidays = calendar.holidays(date(1970, 1, 1), date(2200, 1, 1), observed=True)
    ...
    def interest_payment(self, period):
        ...
        `bop_principal` property. Rounds to the nearest cent.
        ...
        return round(period.interest_rate * yf * period.bop_principal, 2)
...
class FixedRateBorrowing(PeriodicBorrowing):
    ...
    **kwargs
    ...
    def _constant_pmt_amort(self, period):
        ...
        return round(pmt - period.interest_payment, 2)
