...
[Open documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/)
...
class MediaStoreDataClient(BaseClient):
    ...
    [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#can_paginate)
        """
    ...
    def delete_object(self, *, Path: str) -> Dict[str, Any]:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#delete_object)
        """
    ...
    def describe_object(self, *, Path: str) -> DescribeObjectResponseTypeDef:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#describe_object)
        """
    ...
    def generate_presigned_url(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#generate_presigned_url)
        """
    ...
    def get_object(self, *, Path: str, Range: str = ...) -> GetObjectResponseTypeDef:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#get_object)
        """
    ...
    def list_items(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#list_items)
        """
    ...
    def put_object(
        ...
        *,
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#put_object)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_items"]) -> ListItemsPaginator:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore_data/client/#get_paginator)
        """
