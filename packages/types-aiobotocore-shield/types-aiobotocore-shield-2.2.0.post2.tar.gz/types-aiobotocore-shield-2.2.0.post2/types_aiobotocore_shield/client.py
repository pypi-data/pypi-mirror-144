...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/)
...
class ShieldClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#exceptions)
        """
    ...
    async def associate_drt_log_bucket(self, *, LogBucket: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_drt_log_bucket)
        """
    ...
    async def associate_drt_role(self, *, RoleArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_drt_role)
        """
    ...
    async def associate_health_check(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_health_check)
        """
    ...
    async def associate_proactive_engagement_details(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_proactive_engagement_details)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#can_paginate)
        """
    ...
    async def create_protection(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#create_protection)
        """
    ...
    async def create_protection_group(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#create_protection_group)
        """
    ...
    async def create_subscription(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#create_subscription)
        """
    ...
    async def delete_protection(self, *, ProtectionId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#delete_protection)
        """
    ...
    async def delete_protection_group(self, *, ProtectionGroupId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#delete_protection_group)
        """
    ...
    async def delete_subscription(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#delete_subscription)
        """
    ...
    async def describe_attack(self, *, AttackId: str) -> DescribeAttackResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_attack)
        """
    ...
    async def describe_attack_statistics(self) -> DescribeAttackStatisticsResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_attack_statistics)
        """
    ...
    async def describe_drt_access(self) -> DescribeDRTAccessResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_drt_access)
        """
    ...
    async def describe_emergency_contact_settings(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_emergency_contact_settings)
        """
    ...
    async def describe_protection(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_protection)
        """
    ...
    async def describe_protection_group(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_protection_group)
        """
    ...
    async def describe_subscription(self) -> DescribeSubscriptionResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_subscription)
        """
    ...
    async def disable_application_layer_automatic_response(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disable_application_layer_automatic_response)
        """
    ...
    async def disable_proactive_engagement(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disable_proactive_engagement)
        """
    ...
    async def disassociate_drt_log_bucket(self, *, LogBucket: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disassociate_drt_log_bucket)
        """
    ...
    async def disassociate_drt_role(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disassociate_drt_role)
        """
    ...
    async def disassociate_health_check(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disassociate_health_check)
        """
    ...
    async def enable_application_layer_automatic_response(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#enable_application_layer_automatic_response)
        """
    ...
    async def enable_proactive_engagement(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#enable_proactive_engagement)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#generate_presigned_url)
        """
    ...
    async def get_subscription_state(self) -> GetSubscriptionStateResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#get_subscription_state)
        """
    ...
    async def list_attacks(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_attacks)
        """
    ...
    async def list_protection_groups(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_protection_groups)
        """
    ...
    async def list_protections(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_protections)
        """
    ...
    async def list_resources_in_protection_group(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_resources_in_protection_group)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_tags_for_resource)
        """
    ...
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceARN: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#untag_resource)
        """
    ...
    async def update_application_layer_automatic_response(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_application_layer_automatic_response)
        """
    ...
    async def update_emergency_contact_settings(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_emergency_contact_settings)
        """
    ...
    async def update_protection_group(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_protection_group)
        """
    ...
    async def update_subscription(self, *, AutoRenew: AutoRenewType = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_subscription)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_attacks"]) -> ListAttacksPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#get_paginator)
        """
