    ...
    def sort_nameVars(self):
        def fun_key(name):
            if name.find('Coordinate') != -1:
                return ord(name[-1])
            if len(name)==1 and name.lower() in 'xyz':
                return 256 + ord(name)
            return 1000
...
if __name__=='__main__':
    s = read('/media/yxs/learn/pythonAPP/CGNS/Aachen_111_SA.szplt')
    write('/media/yxs/learn/pythonAPP/CGNS/Aachen_111_SA2.szplt',s,False)